...
date: 2026-07-02
status: "VERDICT ISSUED — negative result active at stated tiers"
...
|---|---|---|---|
| PF1 | multiplicative beats additive | **FAIL** | additive (6,721) **ties/edges** Cobb-Douglas (6,799) out-of-sample — the product earns no advantage |
| PF2 | symmetric balance-product (a≈b, a+b≈1) | **FAIL** | a=0.61 ≠ b=0.44 — labor and capital enter **asymmetrically**, so there is **no `Φ=ν` equator optimum** |
| PF2b | literal `Φ×V` (unit elasticities) ≈ general CD | **FAIL** | forcing a=b=1 gives a+b=2 (wrong returns-to-scale) → an ~85× worse fit |
| PF3 | CES substitution ρ ≈ 0 (Cobb-Douglas family) | **FAIL** | best ρ = −0.9, at the **additive/linear** end, away from the product |
...
*— Negative empirical result. Its evidence and interpretation stand or fall by the data, code, and stated scope—not by a private signature.*
