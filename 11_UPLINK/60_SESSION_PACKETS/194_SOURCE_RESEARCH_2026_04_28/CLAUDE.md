...
rosetta:
  ...
  regime: "Brāhmaṇa"
  register: "[I]"
  canonical_phrase: "01_EMERGENTISM/11_UPLINK/60_SESSION_PACKETS/194_SOURCE_RESEARCH_2026_04_28/CLAUDE.md — Agent First-Touch"
---

# 194_SOURCE_RESEARCH_2026_04_28 — Agent First-Touch
...
1. [`00_README.md`](00_README.md) — session packet overview
2. [`AGENTS.md`](AGENTS.md) — agent routing, scope boundaries
3. [`../AGENTS.md`](../AGENTS.md) — parent lane authority
4. `01_ATRAHASIS_AS_BREEDING_PROTOCOL_RESEARCH.md` — Atrahasis research
5. `02_ANUNNAKI_AUTHORITY_PARADOX_RESEARCH.md` — Anunnaki authority paradox research

## Scope

- Session packet 194: Source Research (2026-04-28).
- Uplink content — compressed session synthesis, not source-owner authority.
