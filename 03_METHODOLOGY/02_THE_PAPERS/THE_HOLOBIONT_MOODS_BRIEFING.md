...
sources:
  ...
  - "02_SKYZAI/01_NOOSPHERE/00_HOLOBIONT_SYSTEM_2026_08_01.md:58 ([D] §5 macro-stack: L4 acts, L5 watches, L6 only negates, L7 only orients — apophatic inversion)"
  - "00_HANDOFF/2026-08-01_DOCTRINE_SYNTHESIS_HOLOBIONT_v0.2.md:104-125 ([I, GLOSS] v0.2 §4 mood mapping + K2/SKYZAI row split + pen-splits-by-mode)"
...
The irreducibility principle: **moods are not modules**. A module is a replaceable component; a mood is an irreducible utterance. Removing a module leaves the rest of the system functional; removing a mood leaves a thought incomplete. IS alone is not a thought (it is a tautology); COULD alone is not a thought (it is speculation); SHOULD alone is not a thought (it is exhortation); SHOULD-NOT alone is not a thought (it is refusal); ACT alone is not a thought (it is motion). A thought is the chain of moods that holds the utterance as one sentence — grounded, explored, committed, bounded, instantiated.

The correspondence is not 1:1. The 4 scored organs + 1 immune + 2 boundary + 1 reflective = 8 utterances, but the moods are 5 (indicative / subjunctive / deontic / negative deontic / imperative). The moods are the *underlying structure*; the organs are the *surface instances*. One mood can have multiple organs (e.g. K2 and SKYZAI are both imperative, but with different scopes). One organ can touch multiple moods (e.g. Nexus/Cortex/AIA are reflective, but they witness all moods, not operate one).
...
The v0.1 synthesis had a single "K2 / SKYZAI — imperative" row in the mood table. The v0.2 row split is the load-bearing A7 self-correction: fusing *host* (K2) with *actuator* (SKYZAI) is exactly the cardinal sin §4 names in its next sentence — *"the cardinal sin is merging moods."*
...
### 2.3 Why moods are not modules

A module is a *replaceable* component. Replace the deontic module, the system still functions; it just stops making recommendations.

A mood is an *irreducible* utterance. Remove the indicative mood, the chain has no ground; the system stops being a thought. Remove the deontic mood, the chain has no commitment; the system stops being a decision. Remove the negative deontic, the chain has no boundary; the system stops being constrained. Remove the imperative, the chain has no instantiation; the system stops being an act.

A holobiont's moods are the irreducible utterances that make its sentence a thought. The keystone's "apophatic inversion" (line 58, §5) is the design principle: the higher the level, the less it does; L4 acts, L5 watches, L6 only negates, L7 only orients. Authority is equatorial, sovereignty negative; the corporate pyramid, upside down. The moods are not stacked; they are *held in the sentence* — the apophatic descent subtracts them one by one until the agent reaches the centre (Brahman), and re-emerges as L7 Ṛṣi with inverted teleology (per `THE_RECURSIVE_TRIVIUM.md` §4).
...
- **"Circle decides"** — merges IS with ACT. Observation becomes commitment.
- **"Agentz decides"** — merges SHOULD with ACT. Recommendation becomes command.
- **"ReFu predicts"** — merges COULD with IS. Possibility becomes fact.
- **"EN decides"** — merges SHOULD-NOT with ACT. Refusal becomes execution.
- **"K2 / SKYZAI = imperative (do this)"** — merges host with actuator. Signature becomes operational execution.
- **"The reflective layer decides"** — merges witness with operator. Reflection becomes command.
...
|---|---|---|---|---|
| indicative | Circle | Śūdra | Appetite (Production) | Democracy |
| subjunctive | RealityFutures | Vaiśya | Appetite (Acquisition) | Oligarchy |
| deontic | Agentz | Kṣatriya | Spirit (Honor) | Timocracy |
| negative deontic | EvolutionaryNetwork | (immune, dual seat) | (boundary discriminator) | (L1+L2 adversarial apparatus) |
| imperative (host) | K2 | (constitutional-amender, post-amendment) | (sovereign boundary) | (above or between the regimes) |
...
|---|---|---|---|
| [I, GLOSS] | `02_SKYZAI/01_NOOSPHERE/00_HOLOBIONT_SYSTEM_2026_08_01.md` | §4 (keystone GLOSS, line 56) | K2-ratification pending (D1) |
| [D] | `02_SKYZAI/01_NOOSPHERE/00_HOLOBIONT_SYSTEM_2026_08_01.md` | §5 apophatic inversion (line 58) | K2-ratified 2026-08-01 |
| [I, GLOSS] | `00_HANDOFF/2026-08-01_DOCTRINE_SYNTHESIS_HOLOBIONT_v0.2.md` | §4 (K2/SKYZAI row split) | Mavis-staged 2026-08-01 |
| [B, post-POA] | `00_HANDOFF/2026-08-01_DOCTRINE_SYNTHESIS_HOLOBIONT_v0.2.md` | §4 K2 cell (line 114) | Mavis-staged 2026-08-01 |
| [B] | `00_HANDOFF/2026-08-01_DOCTRINE_SYNTHESIS_HOLOBIONT_v0.2.md` | §4 SKYZAI cell (line 115) | Mavis-staged 2026-08-01 |
| [I, GLOSS] | `00_HANDOFF/2026-08-01_DOCTRINE_SYNTHESIS_HOLOBIONT_v0.2.md` | §4 cardinal-sin self-violation (line 117) | Mavis-staged 2026-08-01 |
| [D] | `01_EMERGENTISM/03_METHODOLOGY/02_THE_PAPERS/THE_HOLOBIONT_MOODS_BRIEFING.md` | (this file) | Emergentism L4 staged 2026-08-01 |

**Out of scope:** D1 K2-as-role amendment ratification. Pending K2 disposition per synthesis v0.2 §6.
