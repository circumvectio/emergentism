...
**Corpus:** Emergentism
**Evidence:** `[A]` external information-thermodynamic baseline; `[S/I]` typed
Emergentist crosswalk; `[C]` quantitative scaling beyond the stated baseline.
...
Landauer's principle constrains logically irreversible information erasure.
Bennett's reversible-computation work prevents the stronger and false claim
that every logical step must dissipate the same minimum heat. Maxwell-demon
analyses keep measurement, memory, feedback, control, and reset inside the
physical system. These are ordinary external results `[A]`; Emergentism does
not derive them.
