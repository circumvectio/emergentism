...
| **R2** | Anti-sycophancy constitution | Full draft + **runnable harness** ([R2_HARNESS/](R2_HARNESS/README.md), battery frozen); **4 exploratory DeepSeek pilots ran 2026-06-10** — headline null and ceiling-limited ([results](R2_HARNESS/PILOT_DEEPSEEK_RESULTS.md)); registered multi-provider study remains unrun; cite SWAY/SYCON |
