...
- `N_node=(Φ̂₄,V₄)` is the live ordered profile. Any organizational or empirical scalar, including `P×,κ=Φ_cV_c`, requires a declared calibration contract `κ`, fair rivals, held-out outcomes, and a kill criterion.
