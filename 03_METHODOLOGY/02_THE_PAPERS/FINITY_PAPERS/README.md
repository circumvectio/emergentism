...
| **VI** | Emergence as the Lens on Dasein | `PAPER_VI_EMERGENCE_AS_LENS_ON_DASEIN.md` | bidirectional emergence as Möbius phase loop; boundary algebra as ontological operator; two centres (0 additive, 1 multiplicative/log); log-coordinate simplification; Riemann sphere theorem; μ-limit dimensional crossing | [A] math · [S/I] reading |
