...
Emergentist framework: a $710,000 initiative to pre-train a neural model using
an Emergentist objective beside standard cross-entropy. This paper reframes
that proposal as a D4 intervention whose actual outputs and receipts can test a
...
Base-model training is an actual D4 computational process described through
D1/D2 mathematics and, where relevant, D3 physical-state models. The ontology
of systemic awareness remains open. Normative alignment does not “live at D5”:
it is assessed through actual D4 behavior and bearer-complete consequences
under the Justice envelope. The lower-cost question is therefore whether a
declared post-training gate improves those outcomes against fair baselines—not
whether software coordinates a D5 ethical geometry.
...
objectives may be culturally bounded or incomplete, but D4 does not mean
...
2. **Depends on:** Paper O's macro-constraint test and the D4/D5 canonical
   reference. No D-register overrides another, and prospective opacity is not a
   theorem of strong emergence.
