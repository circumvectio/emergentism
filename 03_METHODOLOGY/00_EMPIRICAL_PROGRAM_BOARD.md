...
| **Power-Max behavioral discriminator** | Whether the Justice-constrained objective predicts choices or outcomes better than fair domain-native rivals under external authorship and preregistration | Ready for externalization | S15, S16 | A test of bounded predictive usefulness, not a theorem-to-fact promotion | external team and preregistered run | Upgrade the tested domain only if the preregistered discriminator succeeds; retain the normative grammar separately |
