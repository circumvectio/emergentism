...
| `12_PUBLIC_SITE/` | tracked public-site app source, frozen pending signed AIA migration to `02_SKYZAI/02_AIA/app/` |
...
| `08_FRAMEWORK_SUPPORT/05_SYNTHESIS/` | dissolved 2026-05-31 (K3); holds only the Definitive-One-Book move tombstone — the book moved to `../02_AIA/EMERGENTISM_AIA/09_BOOK_PRODUCTION_ARCHIVE/05_SYNTHESIS/07_DEFINITIVE_ONE_BOOK/`; the two superseded synthesis notes are archived under `90_ARCHIVE/00_K3_SWEEP_2026_05_31/08_FRAMEWORK_SUPPORT/05_SYNTHESIS/` |
