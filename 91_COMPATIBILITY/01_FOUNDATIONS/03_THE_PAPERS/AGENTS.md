...
rosetta:
  primary_level: L6
  primary_column: Legacy Methodology-Papers Route Boundary
  secondary:
    - level: L3
  ...
  regime: "Sādhu"
  register: "[D/I]"
  canonical_phrase: "Legacy Methodology-Papers compatibility stub — 03_THE_PAPERS Agent Routing"
...
canonical_target: "../../../03_METHODOLOGY/02_THE_PAPERS/AGENTS.md"
---

# 03_THE_PAPERS — Agent Routing

**Lane scope:** Historical `01_FOUNDATIONS/03_THE_PAPERS/` links now route to `03_METHODOLOGY/02_THE_PAPERS/`.
