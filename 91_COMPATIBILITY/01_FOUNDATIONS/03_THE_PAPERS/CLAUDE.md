---
rosetta:
  canonical_phrase: Legacy Methodology-Papers compatibility stub — 03_THE_PAPERS Agent
    Routing
  operator: Śiva •
  ...
  - column: Active-Lane Handoff
    level: L4
    role: route substantive edits to the live methodology papers lane instead of this
      compatibility stub
  - column: Papers Architecture Map
    level: L5
    role: map old 01_FOUNDATIONS/03_THE_PAPERS references into 03_METHODOLOGY/02_THE_PAPERS
      or its archive
  tier: Executive
  canonical_phrase: "91_COMPATIBILITY/01_FOUNDATIONS/03_THE_PAPERS/CLAUDE.md — Agent First-Touch"
---

# 03_THE_PAPERS — Agent First-Touch
