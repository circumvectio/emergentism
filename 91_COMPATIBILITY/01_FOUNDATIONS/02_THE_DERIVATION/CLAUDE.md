---
rosetta:
  canonical_phrase: Legacy Teleology-Derivation compatibility stub — 02_THE_DERIVATION
    Agent Routing
  operator: Śiva •
  ...
  - column: Active-Lane Handoff
    level: L4
    role: route substantive edits to the live teleology derivation lane instead of
      this compatibility stub
  - column: Derivation Architecture Map
    level: L5
    role: map old 01_FOUNDATIONS/02_THE_DERIVATION references into 01_TELEOLOGY ownership
  tier: Executive
  canonical_phrase: "91_COMPATIBILITY/01_FOUNDATIONS/02_THE_DERIVATION/CLAUDE.md — Agent First-Touch"
---

# 02_THE_DERIVATION — Agent First-Touch
