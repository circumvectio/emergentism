...
The selected D-scaffold uses exactly five candidate emergence crossings
`μ₀…μ₄` through D5. Non-μ `b₆:D5↝D6` marks apophatic
...
| `[B]` | built, measured, or directly receipted |
...
⊙ = • × ○ — an emblem, not field arithmetic.
