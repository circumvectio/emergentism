...
| **The review packet** — artifact-only professional review can avoid participant research, but contact still has explicit prerequisites | **v2 hash set verified 2026-08-01; CONTACT BLOCKED; NOT SENT.** The registry still lacks a non-circular manifest binding, conflict and scope forms, compensation terms, publication permission, and an applicability determination. After those are real, identifying and asking a qualified outsider remains an owner act; *"AI or project-agent review … does not satisfy this external gate."* | `.../REVIEW_BUNDLE_v2.md`; `.../GATE_REGISTRY.json` |
