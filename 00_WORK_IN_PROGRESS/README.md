...
| **The review packet** — artifact-only professional review can avoid participant research, but contact still has explicit prerequisites | **v3 acyclic hash binding verified 2026-08-02; CONTACT BLOCKED; NOT SENT.** The mechanical manifest binding is now real, but the complete review materials bundle, conflict and scope forms, compensation terms, publication permission, and an applicability determination remain missing. After those are real, identifying and asking a qualified outsider remains an owner act; *"AI or project-agent review … does not satisfy this external gate."* | `.../REVIEW_BUNDLE_v3.md`; `.../REVIEW_BUNDLE_BINDING_CONTRACT_v1.md`; `.../GATE_REGISTRY.json` |
