...
| `OWNER_GATE_HELD_PUBLIC_DOCS` | Which byte-identical numbered-doctrine-spine copy is current planning owner, and what K3 custody does the other retain? **No selection is implied.** | public planning/custody routing | `../00_META/00_CONTACT_LIMITED_OWNER_DECISION_DOCKET_2026_08_02.md` (`D-OWNER-01`) |
| `OWNER_GATE_OPEN_TOPOLOGY` | Is `08_FRAMEWORK_SUPPORT/00_META/` a path-specific non-governance exception, or does the active topology change? **No move is implied.** | root/subfolder topology reconciliation | `../00_META/00_CONTACT_LIMITED_OWNER_DECISION_DOCKET_2026_08_02.md` (`D-OWNER-02`) |
