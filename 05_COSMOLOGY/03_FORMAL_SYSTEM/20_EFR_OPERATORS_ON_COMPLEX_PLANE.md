...
rosetta:
  ...
  regime: "Brāhmaṇa"
  register: "[S]"
  canonical_phrase: "THE FOUR OPERATORS ON THE COMPLEX PLANE"
---

# THE FOUR OPERATORS ON THE COMPLEX PLANE
...
## 2. THE FOUR OPERATORS AS VECTOR FIELDS
...
| ← (decrease Re) | ↓ν (Kali) | **CONSTRAINED** (η > 0 only) |

> **Note on complex notation:** Both φ and ν are real positive numbers. The constraint φ·ν = 1 defines a hyperbola in R^2_+, not a curve in C. The complex plane notation is used for visual convenience, not because i plays a role in the dynamics.
...
## 6. SUMMARY: THE OPERATORS AS COMPLEX TRANSFORMATIONS
...
│  • Kali (↓ν):    Move LEFT — CONSTRAINED (η > 0 only)               │
...
5. **Canonical Path:** `01_EMERGENTISM/05_COSMOLOGY/03_FORMAL_SYSTEM/20_EFR_OPERATORS_ON_COMPLEX_PLANE.md`
