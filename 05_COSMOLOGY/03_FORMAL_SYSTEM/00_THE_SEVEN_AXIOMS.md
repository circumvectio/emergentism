...
> **[Supersession banner — 2026-07-20; the 00:01 line, box 3 adopted; authority receipt 145.]** This A1–A7 set is **superseded as operational canon** by the Emergent Axioms **E1–E10** (`06_ONTOLOGY/03_THE_EMERGENT_AXIOMS.md`), adopted by the founder's deliberate line and recorded at receipt 145. The text below is retained in full per K3 archive-first: the genealogical predecessor — every E-axiom traces its inheritance in the successor set's reconciliation table. Where wording differs, **the E-set rules.** *(This banner supersedes the 2026-07-19 successor-candidate banner, which stood while the E-set was staged.)*
