...
> **[Successor-candidate banner — 2026-07-19.]** The Emergent Axioms **E1–E10** (`06_ONTOLOGY/03_THE_EMERGENT_AXIOMS.md`) are staged at `[D]` as a possible successor. No founder-promotion receipt has been recorded. Therefore this A1–A7 set remains signed operational canon, subject to the K3 reconciliation banner and governing receipts below. If the E-set is later adopted, preserve this text as its genealogical predecessor.
