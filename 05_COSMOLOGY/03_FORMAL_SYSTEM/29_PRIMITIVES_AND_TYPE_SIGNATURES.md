...
RegisterRole :=
  ground_boundary | positive_structure | actual_event
...
| `D3` | positive structure | transformation/persistence predicate |
...
An actual D4 carrier may realize D1, D2, and D3 simultaneously:
...
The current component-cross-calibrated but whole-system-unvalidated scaffold
...
- [Seven Axioms — historical genealogy](00_THE_SEVEN_AXIOMS.md)
