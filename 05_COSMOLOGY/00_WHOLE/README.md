...
# Forwarding stub — 05_COSMOLOGY/00_WHOLE/

The whole-view lane, including `03A_CONSTITUTIONAL_INVARIANTS_CANON.md` (the register-tag proposal and the Greek refusal names) was archived on 2026-07-20 under the pure-worldview boundary pass.
...
**Caution:** the archived `03A` §2 table still ships the retracted "leave-with-everything" wording in its exit row (FG-3); quote it only with that flag.
