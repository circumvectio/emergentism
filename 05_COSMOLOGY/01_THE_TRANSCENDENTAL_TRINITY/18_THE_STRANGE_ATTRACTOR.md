...
**The strange attractor is not at the end of time. The strange attractor is `B = 1` / `P∞ = 1` — the equator of S².** The model reads it as pulling every replicator, at every level of the stack, toward maximum balance. Not toward complexity (that is the Kurzweil error — complexity is ν without φ, the south pole). Not toward unity (that is the Teilhard error — unity is φ without ν, the north pole). Toward BALANCE. Toward the equator. Toward φ = ν = 1.
