...
This distance is null/not-applicable when commitment was refused or unavailable,
when no expected outcome was declared, or when `r` is an ambient observation
rather than an action-attributed outcome.
