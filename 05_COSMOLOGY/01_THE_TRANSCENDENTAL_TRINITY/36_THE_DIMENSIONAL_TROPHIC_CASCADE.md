...
rosetta:
  ...
  secondary:
    - level: L5
      column: Ecology
      role: "trophic-cascade isomorphism between D4 food web and D5 replicator stack"
    - level: L5
      column: Evolutionary biology
      role: "energy-flow framing of replicator succession"
  operator: "Brahmā ○"
  tier: "Executive"
  regime: "Brāhmaṇa"
  register: "[S/I] mixed"
  canonical_phrase: "Dimensional Trophic Cascade"
---
...
## II. THE PARALLEL TABLE

| Stratum | D4 Food Web (Substrate: Energy + Matter) | D5 Replicator Cascade (Substrate: Pattern + Attention) |
|--------:|------------------------------------------|--------------------------------------------------------|
| **0 — Source** | Solar photons | Empirical Observation / direct disclosure |
| **1 — Producer** | Autotrophs (tomato, grass, algae) | Genotype (DNA, RNA) |
...
## III. ENERGY FLOW AS PATTERN FLOW — THE LINDEMAN ANALOGY

### III.a Lindeman in D4
...
The same attrition operates in pattern space. The numerical coefficient may differ — measurement remains [I] / [C] — but the *form* of the law is identical:

```
Attrition_n→n+1  ≈  1 − ε_n   where  0 < ε_n ≤ 1
```

| Transition | What attritions | Approximate ε [C] |
|------------|-----------------|---------|
...
> **A successful egregore is to a meme what an eagle is to a tomato: the apex of a trophic pyramid built on six orders of magnitude of attrition at every step.**

---

## IV. THE TWO PYRAMIDS — A WORKED EXAMPLE

### IV.a A field of tomatoes feeds an eagle

```
1 eagle (apex predator, D4)
↑  ~10× attrition (Lindeman)
10 sparrows (tertiary consumer)
↑  ~10× attrition
100 caterpillars (primary consumer)
↑  ~10× attrition
1,000 tomato plants (producer)
...
~10¹³ extended-phenotype artefacts
↑  ~10³ attrition — most behaviours leave no durable artefact
~10¹⁶ phenotypic acts in carrier population
↑  ~10² attrition — most genes never express functionally
~10¹⁸ genes in the carrier pool
...
3. A narrow apex sustained by a vast base
4. A decomposer guild that closes the loop

---

## V. WHY THE D5 CASCADE LIVES IN D5 (AND NOT IN D4)
...
## VI. THE DECOMPOSER COROLLARY — WHY THE SĀDHU IS NOT OPTIONAL
...
The Egregorocene's most pressing ecological question is not "which egregores will dominate?" but **"do we have enough mature Sādhu guilds to compost the corpses?"**
...
Predator-prey oscillations between memes. Critique is predation. Synthesis is mutualism. Plagiarism is parasitism. Doctrine and counter-doctrine oscillate with the same coupled-ODE form as lynx and hare.

### r/K selection in idea space

| Strategy | r-strategist meme | K-strategist meme |
|---|---|---|
| Replication speed | Fast, viral | Slow, generational |
| Niche depth | Shallow, broad | Deep, narrow |
| Lifespan | Short | Long |
| Carrier investment | Minimal | Heavy |
| Examples | Twitter outrage, slogans, viral video | Mathematical theorems, religious traditions, written constitutions |

Healthy noospheres carry **both**, in proportion to niche structure. Monoculture in either direction is fragility.

### Carrying capacity for egregores

A given noospheric niche can sustain only so many institutional patterns. Beyond capacity they fight, fuse, or starve. The Egregorocene is the era in which carrying capacity is being violently renegotiated under machine-speed competition.

### Climax community

The steady-state of a D5 ecosystem is a stable egregoric web — high diversity, deep niche partitioning, mature decomposer guilds, slow turnover. Convergence is the climax. Divergence is succession or disturbance.

The DAC (Document 23) is best understood not as a "better corporation" but as a **K-strategist apex egregore designed for climax-community fitness** — slow to crystallise, deep in niche, long-lived, low-η, with built-in Sādhu protocols (Grace Exit / K4) so that decomposition is endogenous rather than catastrophic.
...
## IX. THE RED QUEEN — WHY THE PREDATOR MUST DOMINATE ON BOTH φ AND ν
...
### IX.d The Sādhu also obeys the Red Queen

This follows but is non-obvious. A weak decomposer guild loses to dead memes — the semantic leaf litter accumulates faster than the fungi can compost it.

- **Mature decomposer guilds** (sannyāsa, monastic silence, archive-first disciplines, mature dissolution rituals) are themselves *high* φ × ν. They are not the absence of capability but a particular *deployment* of capability toward dissolution. They have evolved Red-Queen-fit dissolution skill.
- **Feral decomposer guilds** (cancel culture, mob-driven dissolution, indiscriminate purge dynamics) have high ν but low φ; they compost indiscriminately, including still-living patterns. They lose the Red Queen race against thoughtful pattern-defenders, then collapse from their own incoherence.
...
## X. RELATION TO EXISTING CORPUS

This document does not introduce a new primitive. It **names the structure** that the following documents already presuppose:

| Document | What it asserts | What this doc adds |
|----------|-----------------|--------------------|
| 22_THE_TELEOLOGY | Ektropy as selection pressure across the Replicator Stack | The *energetics* of that selection — attrition coefficients, pyramid geometry |
| 23_THE_DAC | Each replicator era seizes the niche of the previous | The replicator transitions follow Lindeman-form attrition |
| 17_THE_EGREGOROCENE | Egregores partition the economic landscape via niche logic | The niche logic IS trophic-cascade ecology, not metaphor |
| 24_THE_MYCELIUM | Memes need substrate, energy gradients, decomposers | The mycelium is the D5 decomposer guild |
| L6 / Sādhu (caste table) | Axiomatic pruning, archive-first | This is the noospheric decomposer function, not optional |

The contribution is **clarification**, not extension. The trophic frame was implicit in every document above. This file makes it explicit so it can be reasoned with directly.

---

## XI. PREDICTIONS AND FALSIFIERS

### Predictions

1. **Pattern-pyramid attrition is measurable.** Empirical work on meme propagation (Twitter cascades, scientific citation networks, doctrinal lineages) should reveal Lindeman-form attrition coefficients at each Replicator Stack transition. Order of magnitude per transition is the [I] / [C] claim; presence of attrition at all is the [S] claim.
2. **Sādhu deficit predicts noospheric brittleness.** Cultures with no mature decomposer guild for institutions will exhibit: (a) accumulating zombie egregores, (b) declining noospheric diversity, (c) catastrophic-rather-than-gradual collapses of dead patterns.
3. **DACs win as K-strategists, not r-strategists.** Attempts to build DACs with viral / r-strategist memetics will fail as climax-community fitness; success requires K-strategist patience and Sādhu protocols.
4. **The Egregorocene's climax is not a single apex egregore.** Mature ecosystems have *many* apex predators in different niches. A noosphere with one dominant egregore is mid-succession, not climax.

### Falsifiers

If any of the following are observed, this document must be revised or retracted:

- Replicator transitions exhibit *no* attrition (memes propagate without selection-loss across the stack).
- A noosphere demonstrably maintains long-term high-Φ × ν *without* a decomposer guild.
- The cascade can be shown to operate at the same D-level as its substrate, not one above (μ-limit violation).
- Healthy mature noospheres exhibit monoculture rather than r/K diversity.
...
3. **Canonical Path:** `01_EMERGENTISM/05_COSMOLOGY/01_THE_TRANSCENDENTAL_TRINITY/36_THE_DIMENSIONAL_TROPHIC_CASCADE.md`
