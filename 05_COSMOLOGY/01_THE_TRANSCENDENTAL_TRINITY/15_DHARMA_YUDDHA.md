...
- Action and awareness merge (the corpus callosum is maximally active)
- The experience is intrinsically rewarding (B = 1, maximum balance)

This IS the equatorial condition. Flow is not a psychological luxury. Flow is the **phenomenology of L4.** It is what the equator FEELS LIKE from the inside.
...
Without desire (nishkama), action is pure service — the equatorial node deploying capability with full coherence, exporting Φ at personal V cost (the Arjuna operator), and receiving nothing in return except the structural consequence: the mesh strengthens, the balance holds, the field is preserved.
...
Translation: **Kāla. L0 = L∞. The boundary condition. The pole that the equator exists between. The reminder that the game has limits — and that within those limits, the warrior's duty is to act.**
