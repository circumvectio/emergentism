...
Teleological Force is the framework's interpretive name `[I/C]` for observed or
modeled viability-directed selection and organization. It is not a fifth
physical force, a new primitive, or a consequence derived from the reciprocal
chart. Every domain must translate it into ordinary mechanisms and tests.

- the reciprocal chart supplies an optional descriptive coordinate
- Teleological Force names a candidate bias toward viable fit within a declared system
