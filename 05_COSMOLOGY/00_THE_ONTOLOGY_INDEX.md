...
- EFR 24: [Strategic Exclusion](03_FORMAL_SYSTEM/24_GEOMETRIC_EXCLUSION_CONVERGENCE.md)
...
### "What do the Finity Papers say?"

**The programme:** [Finity Papers README](../03_METHODOLOGY/02_THE_PAPERS/FINITY_PAPERS/README.md)

| Paper | Title | Core Claim | Tier |
|---|---|---|---|
...
### "What does the Suda corpus contribute?"

**Start here:**
- [Suda Formal Structures Compendium](../03_METHODOLOGY/02_THE_PAPERS/FINITY_PAPERS/SUDA_FORMAL_STRUCTURES_COMPENDIUM.md)
- [Suda Ontological Resonance Map](../03_METHODOLOGY/02_THE_PAPERS/FINITY_PAPERS/SUDA_ONTOLOGICAL_RESONANCE_MAP.md)
...
### "What is the epistemic status of all this?"

**Start here:** [The Honest Position](../02_EPISTEMOLOGY/01_EVIDENCE_TIERS/00_THE_HONEST_POSITION.md)
...
### "What are the known issues and corrections?"

**Start here:** [L1–L7 Refinement Audit](../01_TELEOLOGY/02_THE_DERIVATION/L1_L7_REFINEMENT_AUDIT.md)

Key corrections already propagated:
- A3 force-mapping re-tiered to [I] (not [S])
- A1 P-constant/P-variable distinction formalized
- C5 corrected to E = −log(B) (not −log(Φ×V))
- Is-Ought reframed as bypass, not closure
- I3 reformulated: consciousness as activity, not position
- S8 qualified: η=0 Nash equilibrium **at equatorial profiles**
- "One infinity" domain-separated (mathematical vs ontological vs physical)
- Trinity-S² co-arising acknowledged (neither prior)

---

### "How does this map to traditional frameworks?"
...
### "What is the empirical program?"

**Start here:** [The Empirical Program Board](../03_METHODOLOGY/00_EMPIRICAL_PROGRAM_BOARD.md)
...
**The honest headline:** Two framework-designed confirmations, one mixed human probe, one informative negative first run, and several stronger pending tests.

---

### "What would kill the framework?"

**Active kill conditions:** [The Honest Position](../02_EPISTEMOLOGY/01_EVIDENCE_TIERS/00_THE_HONEST_POSITION.md) Part VII
...
| AK5 | Jaynes' bicameral hypothesis disproved | Golden Age Hypothesis loses neurological foundation |
| AK6 | Alternative geometry reproduces same convergence | S² claim withdrawn |
| AK7 | Core proofs contain uncorrectable errors | Formal system collapses |

**Already triggered:** AK8 (R* ≈ 1.5 threshold) — actual η_c ≈ 0.58, 2.6× more fragile than predicted. Qualitative claim survives; quantitative threshold replaced.
