...
rosetta:
  ...
  regime: "Sādhu"
  register: "[I]"
  canonical_phrase: "01_EMERGENTISM/90_ARCHIVE/00_K3_SWEEP_2026_05_31/06_ONTOLOGY/CLAUDE.md — Agent First-Touch"
---
...
1. [`AGENTS.md`](AGENTS.md) — agent routing, scope boundaries
2. [`../../AGENTS.md`](../../AGENTS.md) — parent lane authority
3. `AUDIT_REPORT.md` — historical audit artifact

## Scope

- K3 tombstone / historical audit artifact from the 2026-05-31 sweep.
- Preserves Ontology audit context; not current authority.
...
Current Ontology authority resides in [`../../../06_ONTOLOGY/`](../../../06_ONTOLOGY/).
