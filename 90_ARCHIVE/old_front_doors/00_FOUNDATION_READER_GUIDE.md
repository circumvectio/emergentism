...
> Absorber: `00_THE_KERNEL_INDEX.md` (the reading-order / map-entry function is now carried by the Kernel Index).
> Original path: `01_EMERGENTISM/00_FOUNDATION_READER_GUIDE.md` — that path now carries a forwarding stub resolving citations to this stone. Full original content preserved verbatim below this stone; absorber named above. K3: stubbed, never erased. [S]
...
| `04_AXIOLOGY/` | L4 / Strategic Abduction | Justice, value, K2, operators, signed action | Strategic Implementation lives under `04_AXIOLOGY/01_THEURGY/` |
...
**Canonical execution guardrails:** [00_EXECUTION_GUARDRAILS.md](03_METHODOLOGY/00_EXECUTION_GUARDRAILS.md) — one execution surface for Three-Stage Process separation, K2 sovereignty, eta=0, and Grace Exit.
