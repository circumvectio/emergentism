...
rosetta:
  ...
  secondary:
    - level: L5
      column: Philosophy
      role: "systematize Q3 topology and sphere-closure architecture"
    - level: L3
      column: Philosophy
      role: "audit topology/game-theory claims against evidence tiers"
    - level: L6
      column: Philosophy
      role: "bound Kālī as conditional immune function, not general authorization"
  operator: "Arjuna ⚔"
  tier: "God"
  regime: "Kṣatriya"
  register: "[A/I]"
  canonical_phrase: "MF-70 — Kālī Closes the Sphere"
---
...
**Evidence Tier:** [A/I] Elementary topology + game theory + Interpretive synthesis
**Dependencies:** S0, MF-36, MF-42, MF-63 (Möbius Classification), K_STAR_ZERO, FRAMEWORK_GAME_THEORY
...
- **Forgiving:** If the other returns to cooperation, cooperate immediately
- **Transparent:** The rule is known
...
- **Nice:** Do not enter Q3 unprovoked. Against cooperators (Q1, Q2, Q4 agents), K* = 0 applies.
- **Retaliatory:** Against defectors (agents in Q3), enter Q3 to match. This is Kālī.
...
The biological immune system: [I]
- Does not attack healthy tissue (K* = 0 against self)
- Attacks pathogens vigorously (retaliatory response against invaders)
- Stands down when the threat is neutralized (forgiving)
- Operates by fixed rules (transparent — innate immunity follows genetic programming)
...
Without Kālī:
- Defectors punch holes in the cooperation surface
- The sphere loses compactness
- The equator becomes contractible
- The P_max guarantee is lost [I]
- The framework collapses

With Kālī:
- Every hole is sealed by retaliatory response
- The sphere remains compact
- The equator remains non-trivial
- P_max = ½ is maintained
- The framework holds
...
- Christianity: Michael, the harrowing of Hell — military angel, hell-descent
- Islam: Malik al-Ḥarb — the warrior aspect of high-priority justice
- Judaism: Din (strict judgment) — the sephira that constrains
- Taoism: The complementary role of destruction in the Tao
...
- **Canonical Path:** 01_EMERGENTISM/08_FRAMEWORK_SUPPORT/02_OPERATORS/SPHERE_DERIVATIONS/MF_70_Kali_Closes_Sphere.md
