...
> **[金] Authority seam — 2026-07-20.** This preserved operator paper is not live authority where it conflicts with the Egregoreotype candidate test or pure-Emergentism boundary. Collective persistence does not presume consciousness, personhood, or a preferred product architecture.
...
### 5.2 A Candidate Mutualist Horn Network

A candidate mutualist collective could combine:
...
- reversible fission when sub-networks saturate

This remains a design hypothesis. It must be tested by carrier turnover, outcome
receipts, intervention effects, visible costs, correction, and exit; the phrase
“optimal network” is not licensed without comparison against alternatives.
...
An Egregoreotype candidate is a network of coupled agents whose persistent trace
survives carrier turnover and measurably reweights later selection. Shared models
can expand a collective option cone without expanding any physical light cone.
Capture occurs when the trace redirects collective computation toward its own
persistence at visible substrate cost. Mathematical encoding, self-correction,
custody, consent, contest, and exit are candidate defenses, not guarantees.
