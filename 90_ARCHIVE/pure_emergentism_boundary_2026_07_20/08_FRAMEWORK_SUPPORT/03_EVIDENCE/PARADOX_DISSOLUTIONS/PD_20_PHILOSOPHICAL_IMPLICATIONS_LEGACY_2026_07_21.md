...
rosetta:
  ...
  secondary:
    - level: L2
      column: Philosophy
      role: "retain interpretive scope and paradox-index status"
    - level: L4
      column: Philosophy
      role: "connect philosophy-as-practice to judgment and ethics"
    - level: L6
      column: Philosophy
      role: "bound completion and ground claims"
  operator: "Brahmā ○"
  tier: "Executive"
  regime: "Brāhmaṇa"
  register: "[I]"
  canonical_phrase: "PD-20 — Philosophy After Dissolution"
---
...
**Canonical Number:** PD_20 (see [PD_00_INDEX](PD_00_INDEX.md) for the definitive numbering table)
...
| D6 | Positive articulation is suspended; `r₆` compares its boundary role with D0 without identity | The sitting practice of release |
