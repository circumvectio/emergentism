...
title: "D Series Constitutional — Claude compatibility route"
status: "ACTIVE — pure Emergentism route, 2026-07-20"
evidence_tier: "[S] routing discipline; content retains owner-declared tiers."
---

# D Series Constitutional — Claude compatibility route

**Lane:** `08_FRAMEWORK_SUPPORT/03_EVIDENCE/ROSETTA_STONE/D_SERIES_CONSTITUTIONAL`
...
- [Kintsugi repair receipt](../../../../11_UPLINK/50_AUDITS_AND_EXECUTIONS/127_EMERGENTIST_COMPASS_KINTSUGI_REPAIR_2026_07_18.md)
...
- D4 is actual; D5 is possible. Five candidate crossings are `μ₀…μ₄`; `b₆` and `r₆` are non-μ interpretive edges.
