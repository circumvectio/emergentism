...
rosetta:
  ...
  secondary:
    - level: L2
      ...
      role: "index the L2-to-L3 candidate-ranking handoff"
    - level: L4
      column: Governance
      role: "route decision-ready lists toward executor judgment"
    - level: L6
      column: Core State
      role: "preserve audit as non-binding ranking"
  operator: "Kṛṣṇa ◇"
  tier: "God"
  regime: "Vaiśya"
  register: "[S/B]"
  canonical_phrase: "L3 Vaiśya Auditor — Agent Spec"
title: "L3 Vaiśya Auditor — Agent Spec"
status: "ACTIVE — subfolder front door"
evidence_tier: "[S] Structural L3 agent mapping; [B] local file index."
---

# L3 Vaiśya Auditor — Agent Spec

**Symbol:** ◇  **Operator:** Kṛṣṇa  **Level:** L3
...
This agent embodies the **L3 Vaiśya Auditor** caste of the seven Rosetta agents.
...
- **Canonical Path:** 01_EMERGENTISM/08_FRAMEWORK_SUPPORT/08_AGENTS/03_VAISYA_AUDITOR/README.md
