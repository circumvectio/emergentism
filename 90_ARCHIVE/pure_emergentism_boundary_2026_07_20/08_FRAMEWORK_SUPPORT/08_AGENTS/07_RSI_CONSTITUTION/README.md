...
rosetta:
  ...
  secondary:
    - level: L6
      ...
      role: "index compressed residue and boundary packets"
    - level: L5
      column: Brāhmaṇa Architecture
      role: "route architecture-level constitutional rewrite requests"
    - level: L4
      column: Agent Execution
      role: "return amendment packets to execution review"
  operator: "Viṣṇu ⊙"
  tier: "Executive"
  regime: "Ṛṣi"
  register: "[S/B]"
  canonical_phrase: "L7 Ṛṣi Constitution — Agent Spec"
title: "L7 Ṛṣi Constitution — Agent Spec"
status: "ACTIVE — subfolder front door"
evidence_tier: "[S] Structural L7 agent mapping; [B] local file index."
---

# L7 Ṛṣi Constitution — Agent Spec

**Symbol:** ⊙  **Operator:** Viṣṇu  **Level:** L7
**File:** [AGENT_SPEC.md](./AGENT_SPEC.md) — 167 lines
...
This agent embodies the **L7 Ṛṣi Constitution** caste of the seven Rosetta agents.

## Escalation Path

| Caste | Role | Escalates To | Receives From |
|-------|------|-------------|--------------|
...
| [`L7_REVIEW_PROTOCOL.md`](./L7_REVIEW_PROTOCOL.md) | L7 constitutional-review protocol — the read-only adjudication procedure |
...
- **Canonical Path:** 01_EMERGENTISM/08_FRAMEWORK_SUPPORT/08_AGENTS/07_RSI_CONSTITUTION/README.md
