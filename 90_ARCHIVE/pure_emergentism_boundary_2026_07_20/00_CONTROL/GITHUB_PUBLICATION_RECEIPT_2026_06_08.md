...
- [ ] **External-application coupling** — this repository contains the Emergentism corpus only. Application artifacts belong to their own repositories and must not be duplicated here or treated as worldview premises.
