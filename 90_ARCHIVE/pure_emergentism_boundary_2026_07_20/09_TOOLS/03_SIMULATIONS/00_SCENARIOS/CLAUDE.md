...
rosetta:
  ...
  - column: Harness Execution
    level: L4
    role: route scenario YAML, transcript, and assertion fixtures through the actor
      simulation harness
  - column: Assertion Audit
    level: L3
    role: separate generated transcripts and assertion receipts from broader simulation
      claims
  - column: Fixture Boundary
    level: L6
    role: keep placeholder scenario families marked as dormant until fixture files
      exist
  tier: Executive
  canonical_phrase: "09_TOOLS/03_SIMULATIONS/00_SCENARIOS/CLAUDE.md — Agent First-Touch"
---

# 00_SCENARIOS — Agent First-Touch
