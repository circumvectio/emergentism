...
| `90_ARCHIVE/tool_noise/2026_07_19_tidy_wave/102_apply/manifest.json:4` *(moved from `11_UPLINK/50_AUDITS_AND_EXECUTIONS/102_apply/` 2026-07-19, K3 tidy wave)* | "a gradient that keeps pulling back to the equator" | unspecified | **SAFE as direction**, already γ-fenced in-file ([D] scope 2026-07-03); must never be re-read as x-chart curvature |
