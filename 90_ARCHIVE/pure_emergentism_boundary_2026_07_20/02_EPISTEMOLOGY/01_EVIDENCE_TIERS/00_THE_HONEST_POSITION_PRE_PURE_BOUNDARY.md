...
| C19 | Willful evolution: the organism selects the niche, not the reverse. The light cone widens at L4. | Speculative (Doc 22) | Empirical niche-construction studies showing directional agency increases with integration level |
...
- [Retired survey-study corpus](../../90_ARCHIVE/2026_07_13_gfs_retraction/README.md) -- archive provenance only; not an active evidence lane
...
- [ ] **Check kill criteria before deploying or publishing.** If any active pre-registered kill condition in Part VII has been triggered (Protocol R shows no complementarity bound, AMRITA underperforms RLHF, Phi-meter shows no correlation, Jaynes disproved, or a new valid model comparison defeats the selected product), report this immediately. The framework must publish failures, not hide them.
