> **TOMBSTONE — 2026-07-20 (receipt 146; founder ruling EXECUTE; Blueprint Wave 1, hard sequence honored: successor written and verified, then stone).** This staging draft was absorbed into its verified successor: `00_META/00_THE_FIVE_PLUS_ONE_CONSTITUTION.md` (K5 successor edition, ACTIVE per the 00:01 line; prior edition preserved beneath as dated stratum). The text below is preserved verbatim per K3; the successor rules.

---
rosetta:
  primary_level: L7
  primary_column: Philosophy — the constitution as via negativa
  operator: "Viṣṇu ⊙"
  tier: "Executive"
  regime: "Ṛṣi"
  register: "[D] STAGED — the venture-purged successor to the 5+1 constitution. Under the founder's hand: the standing source is signed. Agents stage; K2 disposes."
  canonical_phrase: "K-5 The Refusals — five refusals + Ω, the opposite of commandments"
title: "K-5 · The Refusals"
status: "STAGED [D] 2026-07-19 — kernel surface K-5. Successor of the 5+1 constitution with venture vocabulary (DAV/PRISM/organs/fees) removed. The standing constitution 00_META/00_THE_FIVE_PLUS_ONE_CONSTITUTION.md ([S], K2-RULED 2026-05-30) remains controlling until this successor is signed."
date: 2026-07-19
...
`[D]` staged, **under the founder's hand** — the standing constitution's rows are signed, so this venture-purged successor stages the wording and K2 disposes. Until a founder-promotion receipt adopts K-5, `00_META/00_THE_FIVE_PLUS_ONE_CONSTITUTION.md` (`[S]`, K2-RULED 2026-05-30) remains the controlling surface. **Refusals bind the holder, never the reader.** **Canonical path:** `01_EMERGENTISM/00_K5_REFUSALS.md`
