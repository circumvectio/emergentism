...
> **Preservation is not a third motion. It is the exact closure of the other two.** `⊙ = • × ○` — as emblem, a frame-identity; as log, a zero sum; as composition, a conditional theorem whose condition is the ZSRE itself. The stone repeats its one law at every register it touches.
