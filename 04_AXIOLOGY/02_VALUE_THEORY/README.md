...
rosetta:
  ...
  regime: "Kṣatriya"
  register: "[I]"
  canonical_phrase: "02_VALUE_THEORY"
---
...
- Theurgical practice and K2 participation. Route that to `../01_THEURGY/`.
- Operator grammar. Route that to `../../08_FRAMEWORK_SUPPORT/02_OPERATORS/`.
- Public institutional narrative. Route that to `../../07_THEOLOGY/`.
...
3. **Apply the Dasein game test.** A value claim is not stable until it can state how it raises both `P_node,i` and `P_node,H` under `η=0`.
