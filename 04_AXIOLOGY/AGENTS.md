...
rosetta:
  ...
  regime: "Kṣatriya"
  register: "[S]"
  canonical_phrase: "04_AXIOLOGY — What We Value"
---
...
| | |
|---|---|
| **Virtue** | Dhṛti — fortitude; commit when a constitutional path exists; refuse when it does not |
| **Vice** | Violence — fighting without purpose; forcing where no constitutional path exists |
...
[`../00_META/03_AGENTZ_DEPLOYMENT_04_AXIOLOGY_2026_06_04.csv`](../00_META/03_AGENTZ_DEPLOYMENT_04_AXIOLOGY_2026_06_04.csv).
...
- `01_THEURGY/README.md`
- `02_VALUE_THEORY/README.md`
