...
> 🪦 TOMBSTONE — T2 (ethic-as-theorem, line 141). The "conserved quantity" framing above is the CC-CORE-1 reverse shape: A2 is posited as operational definition, *not* derived from `φ·ν=1` or the manifold identity. The directional claim survives as `[I]` (a chosen operational vow, Model-A gate), but the "conservation-style law" reframe is RETIRED per receipt 126 A2 + Amrita §II P9. Bannered 2026-07-19.
