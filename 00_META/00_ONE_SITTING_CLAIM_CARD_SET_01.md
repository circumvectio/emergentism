...
| OS01-09 | §6, lines 149–163. **Retain, narrowed.** | K-1, K-3 E6, K-4 W3–W4 / selected model `[I/C]`. | Normalized harmonic, Cobb–Douglas, CES, additive, and nonnumeric models may predict better. Replace the selected minimum if a fair rival wins without violating the AND-class boundary; retire numeric aggregation if no defensible scale exists. The map/means distinction survives. | “The selected task convention uses the weaker of evaluated possibilities and actual means; the product is retired as a ranking, and neither form measures worth.” |
