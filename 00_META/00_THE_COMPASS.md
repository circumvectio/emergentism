...
rosetta:
  ...
  tier: "Executive"
  regime: "Ṛṣi"
  register: "[I] — navigational compression; components externally cross-calibrated, whole unvalidated"
  canonical_phrase: "THE COMPASS — MODEL POSSIBILITY, COMMIT ACTUALITY, ANSWER TO RECEIPTS"
date: 2026-07-17
status: "ACTIVE [I] — internally repaired; component cross-calibration completed 2026-07-20; integrated synthesis externally unvalidated"
---
...
This instrument is externally cross-calibrated **by component**, not validated
as an integrated worldview. It remains an `[I]` translation grammar whose
value must be tested by whether it improves real
