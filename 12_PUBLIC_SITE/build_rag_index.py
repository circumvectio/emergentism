...
LANDING_PAGES = ["compass", "map", "lab", "contribute", "dimensions", "check", "plainly", "dasein", "f5", "practice", "record", "record/eub-1", "exit"]
...
OVERVIEW_PAGES = ["compass", "map", "lab", "contribute", "dimensions", "check", "plainly", "dasein", "f5", "practice", "record", "record/eub-1", "exit",
                  "0", "1", "2", "3", "4", "5", "6"]
