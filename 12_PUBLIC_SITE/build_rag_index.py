...
LANDING_PAGES = ["compass", "map", "lab", "contribute", "dimensions", "check", "plainly", "dasein", "f5", "questions", "questions/diagnoses", "ethics", "churn", "amrita", "halahala", "practice", "record", "record/eub-1", "record/pqa-54", "record/churning", "exit"]
...
OVERVIEW_PAGES = ["compass", "map", "lab", "contribute", "dimensions", "check", "plainly", "dasein", "f5", "questions", "questions/diagnoses", "ethics", "churn", "amrita", "halahala", "practice", "record", "record/eub-1", "record/pqa-54", "record/churning", "exit",
                  "0", "1", "2", "3", "4", "5", "6"]
