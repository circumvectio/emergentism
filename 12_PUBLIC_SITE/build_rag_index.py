...
LANDING_PAGES = ["spark", "compass", "map", "lab", "contribute", "dimensions", "check", "plainly", "practice", "record", "exit"]
...
OVERVIEW_PAGES = ["spark", "compass", "map", "lab", "contribute", "dimensions", "check", "plainly", "practice", "record", "exit",
                  "0", "1", "2", "3", "4", "5", "6"]
