...
class LivingMapContractTests(unittest.TestCase):
    ...
    def test_surface_claims_bind_current_cards_sources_and_markers(self):
        expected = {
            ...
            "5/index.html": {"OS01-09", "OS01-11", "OS01-33", "OS01-34", "OS01-35", "OS01-36"},
            "plainly/index.html": {"OS01-09", "OS01-31", "OS01-32", "OS01-33", "OS01-34", "OS01-35", "OS01-36"},
            ...
            "rosetta/index.html": {"OS01-11", "OS01-33", "OS01-34", "OS01-35", "OS01-36"},
