/* Atlas drawer — the gitbook tree on every page.
   ...
   resources; the Emergentism instrument palette is inline. */
(function () {
  "use strict";
  ...
  fab.id = "atlas-fab";
  fab.type = "button";
  fab.setAttribute("aria-label", "Open the release atlas");
  fab.setAttribute("title", "Open the release atlas");
  ...
  panel.setAttribute("aria-label", "Release atlas tree");
  panel.innerHTML =
    '<div id="atlas-head"><b>EMERGENTISM · ATLAS</b>' +
    '<button id="atlas-close" type="button" aria-label="Close">×</button></div>' +
    '<input id="atlas-q" type="search" placeholder="search the compass…" autocomplete="off">' +
