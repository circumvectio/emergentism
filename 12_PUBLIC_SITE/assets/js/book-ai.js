...
(function () {
  ...
  var css = [
    ...
    ".expand-btn{display:inline-grid;place-items:center;min-width:48px;min-height:48px;margin:6px 0 0 8px;padding:7px 12px;border:1px solid color-mix(in srgb,var(--gold) 44%,transparent);",
    "border-radius:999px;background:none;color:var(--gold-bright);font:700 11px/1.4 'Roboto','Noto Sans',sans-serif;",
    "letter-spacing:0;cursor:pointer;vertical-align:middle;opacity:1}",
    ".expand-btn:hover{opacity:1;background:color-mix(in srgb,var(--gold) 12%,transparent)}",
