...
FORCED_ARTIFACTS = {
    ...
    "formal/29-primitives-and-type-signatures/index.html": "Frozen formal index applies the retired Titan multiplication as a primitive definition.",
    "operators/mf-297-alpha-is-the-coupling/index.html": "Frozen operator page treats retired Titan multiplication as a physical coupling claim.",
    "outline/index.html": "Unadopted outline experiment asserts stronger totality, independence, and universal-projection claims than its reviewed source owners permit.",
    "papers/paper-f-k-minimal/index.html": "Frozen paper repeatedly uses retired Titan multiplication as an affirmative self-contained construction.",
