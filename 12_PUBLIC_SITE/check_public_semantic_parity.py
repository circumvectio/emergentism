...
REQUIRED_PUBLIC_CONTRACTS = {
    "index.html": (
        ...
        EXPECTED_CORE_QUESTION, "A bounded atlas of Being",
        ...
        "Types before claims", "eight frozen gates admitted eight constructed evasions",
        "The Butterfield discriminator", "The describer-residual control",
...
REQUIRED_SURFACE_CARDS = {
    "index.html": {
        "FIN01-01", "OS01-01", "OS01-06", "OS01-10", "OS01-12",
        "OS01-13", "OS01-20", "OS01-23", "OS01-25",
        "OS01-27", "OS01-31", "OS01-32",
...
REQUIRED_SURFACE_MARKERS = {
    "index.html": {
        ...
        "no theorem is claimed as ours", "Selections that do work",
        "Types before claims", "eight frozen gates admitted eight constructed evasions",
        "the prediction failed", "The preregistered seven-ology double-coding protocol has not run",
        "R2 says nothing about M4/F3",
        "Counterexamples with teeth", "The Butterfield discriminator",
        "Can two modes be exhaustive?", "One complete ledger instance at D5",
        ...
        "Prepared decision transaction · unsigned",
        "The action exit is the signature boundary", "The map remains optional.",
    },
    "dasein/index.html": {
