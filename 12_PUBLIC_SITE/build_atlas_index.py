...
OVERVIEW = [
    ...
    ("start", "Start and practice", ["", "plainly", "dasein", "questions", "ethics", "practice", "established", "record", "read", "book", "about", "exit"]),
    ...
    ("participate", "Open research", ["f5", "map", "lab", "record/eub-1", "record/pqa-54", "contribute"]),
]
