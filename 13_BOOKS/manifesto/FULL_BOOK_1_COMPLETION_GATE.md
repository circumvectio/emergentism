...
appendices, 67,135 words, and 653 unique source-mapped units. Its deterministic
...
|---|---|---|
| C1 | The assembled reader was a routing stub with no full-book markers or source receipts. | **Resolved:** `MANIFESTO_BOOK_1.md` is one inline 67,135-word reader with 653 unique receipt markers. |
