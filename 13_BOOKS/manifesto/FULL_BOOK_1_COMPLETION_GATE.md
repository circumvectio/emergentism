...
appendices, 67,806 words, and 656 unique source-mapped units. Its deterministic
...
|---|---|---|
| C1 | The assembled reader was a routing stub with no full-book markers or source receipts. | **Resolved:** `MANIFESTO_BOOK_1.md` is one inline 67,806-word reader with 656 unique receipt markers. |
