...
appendices, 64,280 words, and 642 unique source-mapped units. Its deterministic
...
|---|---|---|
| C1 | The assembled reader was a routing stub with no full-book markers or source receipts. | **Resolved:** `MANIFESTO_BOOK_1.md` is one inline 64,280-word reader with 642 unique receipt markers. |
