...
appendices, 63,615 words, and 638 unique source-mapped units. Its deterministic
...
|---|---|---|
| C1 | The assembled reader was a routing stub with no full-book markers or source receipts. | **Resolved:** `MANIFESTO_BOOK_1.md` is one inline 63,615-word reader with 638 unique receipt markers. |
