---
title: "D4  D4 — THE ACTUAL · RECEIPTS"
station: "D4 — D4 — THE ACTUAL · RECEIPTS"
...
The register of what actually happened: instruments that ran, gates that fired,
...
- **Doctrine.** `live=115` is uninterpretable as a doctrine measure until the census
...
- **Anchors** — `path` + exact quoted string, each verified present in the target before it was written
  ...
  - `15_THE_TITAN_PASS_2026_08_06/04_CREATE.md` — "no `anchor` and no `fingerprint_sha256` at all"
  - `15_THE_TITAN_PASS_2026_08_06/04_CREATE.md` — "reviewed_source_sha256"
- ⚠️ **Station tension** — no named attack — this entry carries a **Finding**, verified, in place of an *attack survived*; see the station note on how the survival test changes shape
...
- **Anchors** — `path` + exact quoted string, each verified present in the target before it was written
  - `15_THE_TITAN_PASS_2026_08_06/01_PRESERVE.md` — "### P-34 · 20 of the 28 orphaned cards are recoverable by pure path substitution"
- ⚠️ **Station tension** — no named attack — this entry carries a **Finding**, verified, in place of an *attack survived*; see the station note on how the survival test changes shape
...
- entries at this station: **5** — `python3 16_THE_EMISSION/emit.py --counts`
- station tensions flagged here: **5** — `python3 16_THE_EMISSION/emit.py --counts`
- anchors written from this file: see `16_THE_EMISSION/ANCHORS.jsonl`, `grep -c '"from_file": "A_THE_LADDER/05_D4_ACTUAL.md"' 16_THE_EMISSION/ANCHORS.jsonl`
