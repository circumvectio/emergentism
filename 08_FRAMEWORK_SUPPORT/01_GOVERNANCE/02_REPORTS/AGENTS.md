...
rosetta:
  ...
  secondary:
    - level: L3
      column: Philosophy
      role: "audit report, brief, debrief, and proof-receipt authority"
    - level: L6
      column: Philosophy
      role: "separate dated reports from source doctrine"
    - level: L5
      column: Philosophy
      role: "stabilize report-set topology inside governance"
  operator: "Arjuna ⚔"
  tier: "God"
  regime: "Kṣatriya"
  register: "[I]"
  canonical_phrase: "02_REPORTS — Agent Routing"
---

# 02_REPORTS — Agent Routing

**Lane scope:** Governed home for dated internal reports, audits, briefs, and debriefs.
**Primary lead:** `L4 Kṣatriya`
**Support:** L3 Vaiśya, L5 Brāhmaṇa, L6 Sādhu, L7 Ṛṣi
**Evidence tier:** `[I]` report routing; individual reports keep their own `[A/B/S/I/D/C]` status.
