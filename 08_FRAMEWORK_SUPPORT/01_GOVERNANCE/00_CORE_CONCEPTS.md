...
rosetta:
  ...
  secondary:
    - level: L5
      column: Philosophy
      role: "stabilize core operational definitions for the support library"
    - level: L3
      column: Philosophy
      role: "keep formal-system and evidence-tier references auditable"
    - level: L6
      column: Philosophy
      role: "bound doctrine as ladder, not identity or possession"
  operator: "Arjuna ⚔"
  tier: "God"
  regime: "Kṣatriya"
  register: "[S/I]"
  canonical_phrase: "EFR Core Concepts — Governance Definitions"
---
...
## Reference Document — Other Documents Cite This

**Purpose:** Single source of truth for foundational concepts. Other documents should reference this rather than re-explaining.

**Usage:** Instead of re-deriving the framework from scratch in every document:
...
Read and cite this document in the following dependency order:
...
4. [The Weltanschauung](../../05_COSMOLOGY/00_THE_WELTANSCHAUUNG.md)
5. [Empirical Observation as Primary Disclosure](../../02_EPISTEMOLOGY/00_PRATYAKSA_AS_PRIMARY_DISCLOSURE.md)
6. [Naming Reconciliation](00_NAMING_RECONCILIATION.md)
7. Core Concepts (this file)

**Rule:** Core Concepts may define downstream operational terms, but may not be used to override the canonical formula order, the core state, the canonical Weltanschauung framing, the disclosure-first bridge, or the archetype grammar.
...
## §3: The DAC Architecture

**Decentralized Augmented Corporation** [S/I] Structural model
...
**Evidence tier:** [S/I] — structural model with interpretive elements.
...
**[A] [B] [S] [I] [D] [C]** — The framework's honesty system
...
**Rule:** Every claim in every document should be tagged with its evidence tier. If a document uses simplified presentation, it should state: *"This document uses simplified presentation. See [Core Concepts §6] for evidence tiers."*

**Evidence tier:** [S] The tier system itself is structural (framework convention).

---

## §7: The Immune System

**Corrections Index** [S] Self-correction is active
...
**Evidence tier:** [B] The corrections are documented and verifiable.
...
- **Canonical Path:** 01_EMERGENTISM/08_FRAMEWORK_SUPPORT/01_GOVERNANCE/00_CORE_CONCEPTS.md
