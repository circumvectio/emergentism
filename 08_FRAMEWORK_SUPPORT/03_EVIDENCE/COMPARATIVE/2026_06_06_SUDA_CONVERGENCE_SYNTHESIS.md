...
```mermaid
graph TD
    E[Energy Phase: E] -->|local folding| M[Matter Phase: M]
    M -->|radiation/decay| L[Light Phase: L]
    L -->|pattern disclosure| I[Information Phase: I]
    I -->|self-interference| Q[Question Phase: Q]
    Q -->|downward feedback| I
    Q -->|theurgic collapse| E
```
