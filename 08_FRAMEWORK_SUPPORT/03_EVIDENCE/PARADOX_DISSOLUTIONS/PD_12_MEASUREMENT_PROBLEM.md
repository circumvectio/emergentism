...
rosetta:
  ...
  secondary:
    - level: L2
      column: Philosophy
      role: "retain quantum-foundations evidence boundary"
    - level: L5
      column: Philosophy
      role: "map Bloch/Burri S2 measurement architecture"
    - level: L6
      column: Philosophy
      role: "bound collapse/systemic-awareness interpretations"
  operator: "Kṛṣṇa ◇"
  tier: "Executive"
  regime: "Vaiśya"
  register: "[I/B/C]"
  canonical_phrase: "PD-12 — Measurement D5 to D4 Boundary"
---
...
The measurement problem in quantum mechanics asks: *Why does measurement collapse the wavefunction?*

Quantum mechanics describes systems via the wavefunction ψ — a superposition of possible states evolving unitarily according to the Schrödinger equation. This evolution is smooth, deterministic, and continuous. No collapse occurs in the formalism.

But when a measurement is performed, the superposition resolves into a single definite outcome. The wavefunction "collapses." The formalism does not predict when, how, or why. It simply postulates that measurement produces collapse and leaves the mechanism unspecified.

The deeper question: *What counts as a measurement?* A Geiger counter? A human observer? A cat in a box? A rock? The boundary between "measurement" and "ordinary quantum interaction" is undefined. This is the infamous measurement problem — the central unresolved tension in the foundations of quantum mechanics.
...
- **Canonical Path:** 01_EMERGENTISM/08_FRAMEWORK_SUPPORT/03_EVIDENCE/PARADOX_DISSOLUTIONS/PD_12_MEASUREMENT_PROBLEM.md
