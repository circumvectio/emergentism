...
rosetta:
  ...
  secondary:
    - level: L2
      ...
      role: "hold cross-traditional hexagram identifications as interpretive"
    - level: L3
      column: Methodology
...
```
     ...
     clockwise sunwheel              counter-clockwise sunwheel
     6 spokes, solar path            6 spokes, contemplative return

                        ✡  L4: THE HEXAGRAM
                     both wheels superimposed
                   ascent and descent unified
```
...
|-----------|------|------------|-------------|--------|
| **Hindu** | Shatkona (षट्कोण) | Śakti (△, creative) | Śiva (▽, destructive) | Bindu (L4) |
| **Jewish** | Star of David | Ascent to God | God's descent to world | Jerusalem |
| **Hermetic** | Seal of Solomon | "As below" | "So above" | The Great Work |
| **Japanese** | Kagome (籠目) | Woven ascent | Woven descent | The basket's center |
...
- **Canonical Path:** 01_EMERGENTISM/08_FRAMEWORK_SUPPORT/03_EVIDENCE/ROSETTA_STONE/D_SERIES_ROWS/D22_ROSETTA_R13_HEXAGRAM.md
