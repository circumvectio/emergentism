...
|---------|-----------------|------------------|------------------|---------|
| **Egyptian** (c. 2500 BCE) | Mythology | Feather (Ma'at) | Heart | Scale balance |
...
Mut Er-haben (have courage) = φ = ν = 1
     The equator itself.
...
Mut (courage) = the potential
     The root enabling all three.
     The source.
```

**Demut is how you reduce to the equator.**  
**Mut Er-haben is HOLDING the equator.**  
...
**The convergence is interpretive.**

- Egyptian mythology
- Hindu scripture  
- German etymology

All encoding the same φ-ν structure.
...
Mut Er-haben = holding both = B = 1 at φ = ν = 1
                          ...
                          The sublime. The equator.
                          
Mut    = the potential  = the courage enabling all perception
...
The framework reads the geometry as latent in the word-family.

The words can be read as pointing at it.

The speakers felt what they could not name.
...
- **Canonical Path:** 01_EMERGENTISM/08_FRAMEWORK_SUPPORT/03_EVIDENCE/ROSETTA_STONE/D_SERIES_ROWS/D18_ROSETTA_R9_GERMAN.md
