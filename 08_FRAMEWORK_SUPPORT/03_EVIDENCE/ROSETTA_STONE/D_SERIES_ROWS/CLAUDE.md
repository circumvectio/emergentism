...
rosetta:
  ...
  regime: "Brāhmaṇa"
  register: "[S/I]"
  canonical_phrase: "01_EMERGENTISM/08_FRAMEWORK_SUPPORT/03_EVIDENCE/ROSETTA_STONE/D_SERIES_ROWS/CLAUDE.md — Agent First-Touch"
---

# D_SERIES_ROWS — Agent First-Touch
...
4. [`00_GENERATIVE_TABLE.md`](00_GENERATIVE_TABLE.md) — generative table index

## Scope

- D-Series data rows within the Rosetta Stone evidence lane.
- Individual Rosetta row documents (D13–D17 and beyond).
- Comparative evidence surface; not primary source authority.
