...
rosetta:
  ...
  regime: "Brāhmaṇa"
  register: "[S/I]"
  canonical_phrase: "01_EMERGENTISM/08_FRAMEWORK_SUPPORT/03_EVIDENCE/ROSETTA_STONE/D_SERIES_AGENTS/CLAUDE.md — Agent First-Touch"
---

# D_SERIES_AGENTS — Agent First-Touch
...
4. `D35_L2_SUDRA_KALI_ANALYSIS.md` — agent analysis document

## Scope

- D-Series agent analysis surface within the Rosetta Stone evidence lane.
- Agent-generated comparative analysis; not primary source authority.
