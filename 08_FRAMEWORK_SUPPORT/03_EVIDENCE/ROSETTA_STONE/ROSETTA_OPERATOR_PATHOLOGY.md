...
rosetta:
  primary_level: L3
  primary_column: Clinical Psychology
  secondary:
    - level: L2
      column: Evidence
      role: "preserve DSM categories as established nosology separate from mapping"
    - level: L5
      column: System Architecture
      role: "stabilize operator-pathology and counterfeit-activation tables"
    - level: L6
      column: Core State
      role: "prevent therapeutic implications from becoming clinical advice"
  operator: "Kṛṣṇa ◇"
  tier: "Executive"
  regime: "Vaiśya"
  register: "[E/S/I]"
...
Every operator has a season -- a context in which it is the correct response. Pathology arises not from the operator itself but from being **stuck**: deploying the same operator regardless of context. A2 evaluates outcomes, not operators. No God is good or evil.
...
- **Canonical Path:** 01_EMERGENTISM/08_FRAMEWORK_SUPPORT/03_EVIDENCE/ROSETTA_STONE/ROSETTA_OPERATOR_PATHOLOGY.md
