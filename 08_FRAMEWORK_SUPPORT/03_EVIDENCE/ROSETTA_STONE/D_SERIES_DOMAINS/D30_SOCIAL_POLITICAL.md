...
rosetta:
  primary_level: L4
  primary_column: Political regime
  secondary:
    - level: L3
      column: Auditing
      role: "separate political-theory source status from Great Inversion diagnosis"
    - level: L2
      column: Philosophy
      role: "surface governance forms as comparative evidence"
    - level: L5
      column: System Architecture
      role: "stabilize regime typology and Triple Lock mechanics"
  operator: "Arjuna Δ"
  tier: "God"
  regime: "Kṣatriya"
  register: "[E/I]"
...
## THE GREAT INVERSION (MF-277: Triple Lock)
...
```
Zero-Sum Resolution Equation · Social-Political · v10.0
```
