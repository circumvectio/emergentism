---
rosetta:
  canonical_phrase: 04_VRS_SHEETS — Agent Routing
  operator: Kṛṣṇa ◇
  ...
  - column: Philosophy
    level: L2
    role: preserve evidence-tier and epistemic-status labels
  - column: Philosophy
    level: L4
    role: route practitioner and institutional-design implications
  - column: Philosophy
    level: L6
    role: keep VRS sheets downstream of source doctrine
  tier: God
  canonical_phrase: "08_FRAMEWORK_SUPPORT/03_EVIDENCE/04_VRS_SHEETS/CLAUDE.md — Agent First-Touch"
---

# 04_VRS_SHEETS — Agent First-Touch
...
**Lane scope:** This folder holds VRS sheets and other compact applied review instruments.
