---
type: rosetta-agent-balance-law
title: Rosetta Quality-Quantity Balance Law
timestamp: 2026-07-22T00:00:00Z
status: active
evidence_tier: "[S] design grammar; [I] operational interpretation; empirical calibration unmeasured"
owner: 01_EMERGENTISM/08_FRAMEWORK_SUPPORT/08_AGENTS/MANAGED_AGENTS
---

# Rosetta Quality-Quantity Balance Law

## Ruling

The seven rows order two complementary requirements:
...
model, `φν = 1`. These coordinates are a design model, not an empirical score.
...
1. L1 maximizes bounded coverage and emits classified findings, never a final answer.
...
7. A role crossing its target toward either pole triggers review; a pole claiming the
   whole system fails closed.

For arbitrary observed, normalized positive measures, a diagnostic balance proxy may
be reported as `B_free = 2√(Φ_hat V_hat)/(Φ_hat + V_hat)`. It must not be presented as
validated performance unless the measures and calibration were preregistered.
