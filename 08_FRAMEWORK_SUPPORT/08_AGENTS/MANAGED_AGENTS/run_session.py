...
DEFAULT_TASK = (
    ...
    "claim; archive superseded material with provenance; escalate structural deadlocks "
    "to L5. Act only inside the user's scoped authorization and stop for new authority."
)
