...
rosetta:
  ...
  secondary:
    - level: L3
      column: Agent Audit
      role: "index the L3-to-L4 ranked-option handoff"
    - level: L5
      column: System Architecture
      role: "route redesign needs out of the execution lane"
    - level: L6
      column: Core State
...
title: "L4 Kṣatriya Executor — Agent Spec"
status: "ACTIVE — subfolder front door"
evidence_tier: "[S] Structural L4 agent mapping; [B] local file index."
---

# L4 Kṣatriya Executor — Agent Spec

**Symbol:** ⚔  **Operator:** Arjuna  **Level:** L4
...
This agent embodies the **L4 Kṣatriya Executor** caste of the seven Rosetta agents.
...
- **Canonical Path:** 01_EMERGENTISM/08_FRAMEWORK_SUPPORT/08_AGENTS/04_KSATRIYA_EXECUTOR/README.md
