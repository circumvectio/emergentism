...
rosetta:
  ...
  secondary:
    - level: L3
      column: Philosophy
      role: "route readers through derivation, knife, protocol, and evidence tiers"
    - level: L6
      column: Philosophy
  ...
  regime: "Brāhmaṇa"
  register: "[I/S]"
  canonical_phrase: "Framework Support — Library Front Door"
---
...
`01_EMERGENTISM/08_FRAMEWORK_SUPPORT/` is a post-sevenfold support library for the Rosetta-shaped repository.

- it supports governance, operators, evidence, synthesis, and agent grammar
- it does not replace the seven Foundation source-owner folders
- archived applications, translation, and dissemination material lives under `../90_ARCHIVE/08_FRAMEWORK_SUPPORT/`
- when public language or compressed summaries drift, repair the owning source folder first unless the issue is explicitly about support-library metadata

## Agentz Deployment Control

The 2026-06-04 Agentz deployment receipt for this lane is
[`../00_META/03_AGENTZ_DEPLOYMENT_08_FRAMEWORK_SUPPORT_2026_06_04.md`](../00_META/03_AGENTZ_DEPLOYMENT_08_FRAMEWORK_SUPPORT_2026_06_04.md);
the exact folder/file manifest is
[`../00_META/03_AGENTZ_DEPLOYMENT_08_FRAMEWORK_SUPPORT_2026_06_04.csv`](../00_META/03_AGENTZ_DEPLOYMENT_08_FRAMEWORK_SUPPORT_2026_06_04.csv).
It covers the support library as a support library only: source-owner lanes
...
**Current path note:** this support folder still preserves older prose from the pre-prefix layout. The active physical root is `01_EMERGENTISM/`. Older references to `01_FOUNDATIONS/` should be read through the seven Foundation roots:

- `01_EMERGENTISM/01_TELEOLOGY/`
- `01_EMERGENTISM/02_EPISTEMOLOGY/`
- `01_EMERGENTISM/03_METHODOLOGY/`
- `01_EMERGENTISM/04_AXIOLOGY/`
- `01_EMERGENTISM/05_COSMOLOGY/`
- `01_EMERGENTISM/06_ONTOLOGY/`
- `01_EMERGENTISM/07_THEOLOGY/`

Use `01_EMERGENTISM/00_META/00_SUBFOLDER_ORGANIZATION_STANDARD.md` before adding new sub-subfolders or moving source-owner files.

| Root | Canonical role | Current owner surfaces |
|---|---|---|
| Objective Function | F5 / ektropy / Power Max | F5 packets, derivation surfaces, force-map material |
| Data Science | Beauty / disclosure / induction | `../02_EPISTEMOLOGY/00_PRATYAKSA_AS_PRIMARY_DISCLOSURE.md`, `../02_EPISTEMOLOGY/01_EVIDENCE_TIERS/00_THE_HONEST_POSITION.md`, Rosetta surfaces |
| Auditing | Truth / logic / deduction | `../03_METHODOLOGY/01_THE_DERIVATION/00_THE_DERIVATION.md`, `../05_COSMOLOGY/03_FORMAL_SYSTEM/`, papers |
| Value Alignment | Justice / value / abduction; Strategic Implementation under L4 | `../03_METHODOLOGY/00_EXECUTION_GUARDRAILS.md`, operator grammar, packet 136 |
| System Architecture | Emergentism as positive structure | formula block, Rosetta, Dimensional Framework, formal system |
...
3. **[THE_ONTOLOGY_OF_BEING](../06_ONTOLOGY/00_THE_ONTOLOGY_OF_BEING.md)** -- ground, Being, Dasein, beings
4. **[THE_WELTANSCHAUUNG](../05_COSMOLOGY/00_THE_WELTANSCHAUUNG.md)** -- the canonical statement that the framework is worldview, lens, and toolchain
5. **[SEVENFOLD_FOUNDATION_ROOT](../00_SEVENFOLD_FOUNDATION_ROOT.md)** -- the Rosetta-numbered routing architecture for objective function, data science, methodology, value alignment/theurgy, system architecture, core state, and institutional narrative
6. **[D_SCAFFOLD_L_LADDER_BRIDGE](../00_META/00_D_SCAFFOLD_L_LADDER_BRIDGE.md)** -- why D0-D6 and L1-L7 resonate without collapsing
...
14. **[THE_GLOSSARY](../07_THEOLOGY/00_GLOSSARY.md)** -- public terminology
15. **[THE_MASTER_ROSETTA](03_EVIDENCE/ROSETTA_STONE/00_THE_MASTER_ROSETTA.md)** -- cross-domain mappings of beings and Dasein-structures

**Rule:** books, apps, dissemination copy, and agent prompts should compress from this spine rather than from isolated downstream layers.

### Further Strategic Syntheses

Once the coherence spine is stable, these notes name what the corpus appears to have discovered about itself:

- **[THE_HIDDEN_CENTER_OF_THE_FRAMEWORK](../01_TELEOLOGY/00_THE_HIDDEN_CENTER_OF_THE_FRAMEWORK.md)** — mediation and non-capture as the hidden subject
- **[D5_AS_THE_RESEARCH_ENGINE](../03_METHODOLOGY/00_D5_AS_THE_RESEARCH_ENGINE.md)** — why the strongest public bridge lives at D5
- **[OPAQUE_FROM_BELOW_LEGIBLE_FROM_ABOVE](../02_EPISTEMOLOGY/00_OPAQUE_FROM_BELOW_LEGIBLE_FROM_ABOVE.md)** — the general emergence asymmetry
- **[CONSTITUTIONAL_SCIENCE](../03_METHODOLOGY/00_CONSTITUTIONAL_SCIENCE.md)** — the framework as a science of corrigible systems under scale
...
| Document | Purpose | Dimension |
|----------|---------|-----------|
| [27_DIMENSIONAL_ARCHITECTURE_CLARIFICATION.md](../05_COSMOLOGY/03_FORMAL_SYSTEM/27_DIMENSIONAL_ARCHITECTURE_CLARIFICATION.md) | Full dimensional specification | Meta |
| [34_D4_D5_CANONICAL_REFERENCE.md](../05_COSMOLOGY/03_FORMAL_SYSTEM/34_D4_D5_CANONICAL_REFERENCE.md) | Canonical D4/D5 reference | Meta |
| `05_SYNTHESIS/` | Book I (Sarpasya Vijayam) | D4→D5 transit |
| seven Foundation roots under `../` | Coherence spine, seven-axiom formal system, derivation, and PHI Resolution | D4 foundation |
| `03_EVIDENCE/PARADOX_DISSOLUTIONS/` | 24 paradox papers | D4 dissolution |
...
|--------|-----------------|
| `01_GOVERNANCE/` | Canonical specs, master indexes, antifragility, replication, naming, and audit surfaces |
| seven Foundation roots under `../` | Formula block, core state, Weltanschauung, life-science register, glossary, formal system, derivation, and papers |
...
The active canon no longer relies on a single hidden resolution packet. Drift is controlled through the current governance spine:
...
This tree includes strict source canon, long-form books, generated release
mirrors, peer-review packets, and historical audit closeouts. Run drift scans
through **[00_DRIFT_SCAN_DISCIPLINE.md](01_GOVERNANCE/00_DRIFT_SCAN_DISCIPLINE.md)**
before treating every hit as the same kind of error.

Priority: repair source owners and current public front doors first; mark
mirrors, old audits, and completed review packets by genre before chasing every
legacy phrase.
...
If you're an agent:
- **Working on business/product/code?** → Go to `../../02_SKYZAI/01_NOOSPHERE/CLAUDE.md`
- **Working on philosophy/framework?** → Stay here
- **Not sure?** → Go to `../../02_SKYZAI/01_NOOSPHERE/CLAUDE.md` (most live execution work is there)

## Pratyakṣa as Primary Disclosure

If you can access φ directly through disciplined disclosure, doctrine becomes the after-image rather than the first cause. The framework is a lens and toolchain for those who still need articulation, transmission, testing, and shared method.

Zero-Sum Resolution Equation

## Execution Surface

- **Canonical Path:** 01_EMERGENTISM/08_FRAMEWORK_SUPPORT/README.md
