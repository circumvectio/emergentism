---
rosetta:
  canonical_phrase: MF_ADVANCED — Agent Routing
  operator: Brahmā ○
  ...
  - column: Philosophy
    level: L7
    role: witness advanced operator manuscripts as exploratory synthesis
  - column: Philosophy
    level: L6
    role: bound speculative extensions against canon promotion
  - column: Philosophy
    level: L3
    role: audit evidence tiers and discipline notes before reuse
  tier: Executive
  canonical_phrase: "08_FRAMEWORK_SUPPORT/02_OPERATORS/MF_ADVANCED/CLAUDE.md — Agent First-Touch"
---

# MF_ADVANCED — Agent First-Touch
...
**Lane scope:** This folder holds advanced operator manuscripts and higher-order speculative extensions.
