...
rosetta:
  ...
  secondary:
    - level: L5
      column: Philosophy
      role: "structure language as horn-to-horn channel architecture"
    - level: L3
      column: Philosophy
      role: "audit linguistic and information-theory claims"
    - level: L6
      column: Philosophy
      role: "bound language model as interpretive translation"
  operator: "Kālī 💀"
  tier: "God"
  regime: "Śūdra"
  register: "[I]"
  canonical_phrase: "MF-293 — Language Is Bandwidth"
---
...
- Mathematical layer: zero degradation, universal decoding, silicon-transmissible
- Narrative layer: emotional phase, cultural market fit, human-motivating
- Both layers necessary: mathematics without narrative has no V (nobody reads it); narrative without mathematics has no Φ (it degrades)

P_node = Φ × V applied to the publication itself. The PAPER must have both axes. The mathematical content is the structural Φ. The narrative is the V that carries it into readers' light cones.
