...
rosetta:
  ...
  - column: Philosophy
    level: L3
    role: audit agent-facing compiler and routing-table claims
  - column: Philosophy
    level: L6
    role: bound older Lens material as support metadata, not Ground
  tier: Executive
  canonical_phrase: "08_FRAMEWORK_SUPPORT/00_META/CLAUDE.md — Agent First-Touch"
---
...
5. [`00_AGENT_ENTRY_POINT.md`](00_AGENT_ENTRY_POINT.md)
6. [`00_AGENT_ONBOARDING_SEQUENCE.md`](00_AGENT_ONBOARDING_SEQUENCE.md)

## Scope

**Lane scope:** Framework-support meta lane for agent-facing compilers, routing tables, analysis notes, and older Lens material that still supports the framework but is not itself a Foundation root.
