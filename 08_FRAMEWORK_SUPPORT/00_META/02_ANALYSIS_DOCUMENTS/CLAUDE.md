---
rosetta:
  canonical_phrase: 02_ANALYSIS_DOCUMENTS — Agent Routing
  operator: Brahmā ○
  ...
  - column: Philosophy
    level: L7
    role: witness synthesis and theological-risk implications without making this
      folder canon
  - column: Philosophy
    level: L6
    role: bound reflective analysis as diagnostic support, not doctrine root
  - column: Philosophy
    level: L4
    role: route human action items to explicit owner-lane execution
  tier: Executive
  canonical_phrase: "08_FRAMEWORK_SUPPORT/00_META/02_ANALYSIS_DOCUMENTS/CLAUDE.md — Agent First-Touch"
---

# 02_ANALYSIS_DOCUMENTS — Agent First-Touch
...
5. [`00_APPLIED_INSIGHTS_FROM_INSIDE.md`](00_APPLIED_INSIGHTS_FROM_INSIDE.md)
6. [`00_HUMAN_ACTION_ITEMS.md`](00_HUMAN_ACTION_ITEMS.md)

## Scope

**Lane scope:** This folder gathers analytical reviews, action items, and internal reflective documents produced through the lens layer.
