...
status: "ACTIVE — owner-adopted under Receipt 146 at the source claims' stated tiers"
...
|---|---|---|---|
| K-1 | **Glyph & Grammar** | `05_COSMOLOGY/00_CANONICAL_FORMULA_BLOCK.md` plus `05_COSMOLOGY/01_THE_TRANSCENDENTAL_TRINITY/41_THE_GLYPH_TRANSFORMATIONS.md` | chart `[A]`; emblem/interpretation `[I]`; selected node model at its declared tier |
...
External contact is recorded in
