...
provenance: "Workflow wf_223bec21 (churn of 12 lanes, 72 nectar + 48 halāhala) + the 2026-07-02/03 empirical program + receipts 108, 126, 130, and 131. The 2026-07-19 recovery revision integrates AND-class, Rosetta split-verdict, planetary-confound, anti-reinflation corrections, and the complete 2026-07-16 GFS retirement."
authority_boundary: "Evidence distillation only. Active philosophical authority is 00_THE_EMERGENTIST_WELTANSCHAUUNG.md and its Kernel Index owners. The retired GFS corpus carries no active evidentiary weight."
---
...
20. **Kill criteria actually honored.** `AK8 (R*≈1.5)` was marked **falsified** and retired; the entire GFS study corpus was retired when its proxy, custody, and claim-fit limits became load-bearing; a Paper-V pilot **fired its own** pre-registered kill and reported preliminary falsification. Self-correction means preserving the receipt while withdrawing the claim.
...
- **P2 · The symmetric balance *hump* as an empirical law.** `output = φ×ν`, maximized *at* `φ=ν`, the whole `L4`-apex superstructure — **not established**, and contradicted by the Munnell balance *trough* at aggregate scale. The former GFS result is retired and carries no current weight. Only **conjunction** (need-both) survives, and only untested at single-agent scale. The multiplicative-vs-additive core is an **unwon wager**, not a result.
