...
- **P12 · Convergence-as-proof sharpened by planetary diffusion (adjudication 2026-07-19).** The single cleanest "independent" witness for the Rosetta's seven — the Mithraic seven grades (Corax→Pater mapping Mercury→Saturn) — has its "seven" over-determined by the naked-eye sky. Three sub-points:
  - **Witness identification.** Corax→Pater maps Mercury→Saturn. The "seven" isn't a balance-ladder discovery; it's the seven classical planets, the same seven that gives seven days, seven metals, and seven as a structural number across the entire Hellenistic-Mediterranean-Vedic diffusion family.
  - **Search evidence.** The corpus never notices — a full-text search for "planet," "septenary," or "hebdomad" in the Rosetta context returns nothing. A fired-but-unnamed confound (A7).
  - **Diffusion genealogy.** The traditions that *don't* fit (Buddhist ten, Daoist three-to-five, Confucian eight, Sub-Saharan, Polynesian, Mesoamerican) are precisely the ones with no diffusion path into that civilizational family. **Independence and fit are anti-correlated** — the signature of a planetary-mnemonic seven handed down one lineage, not a balance-ladder independently discovered.
  Concrete instance of **P5** with named witnesses; the kill-criterion the Rosetta's scope-narrowing always was, now with the confounded source named. See `00_RECEIPT_BROKEN_66_SECOND_LOOK_2026_07_19.md` §2 row 7 (Rosetta universal) for the second-look reframe. *[K2-aware, not K2-signed; audit-record addition, no tier movement.]*
