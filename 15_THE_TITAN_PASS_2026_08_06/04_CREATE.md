...
- **Replaces** Nothing. It closes r177's **HOLE 0** — *"The corpus had five validators and NOTHING RAN THEM"* — which is the exact defect `gate.sh`'s own header says it was built to close.
- **owner_class** AGENT.
