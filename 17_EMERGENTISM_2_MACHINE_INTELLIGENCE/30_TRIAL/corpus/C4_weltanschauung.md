...
*•  ⊙  ○ — the map is finished enough. Clean the shrine, then leave it for the road. The measurement problem is solved by §7.2's decoherence filter.*
...
- Authorization, authorship, evidence, and truth are the same type at D4. The D-ladder proves this.
