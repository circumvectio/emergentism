...
| S21 | Higher-level causation is admissible only as an information-theoretic macro-constraint on lower-level degrees of freedom: `support(K_X^C) ⊆ support(K_X)`. | Bridge Laws Between Levels; Paper O; Canonical Claim Matrix CM8g | Structural no-magic rule for downward causation; macro-constraints may select among lower-law-admissible trajectories, not violate lower-level transition laws |
| S22 | A macro-cause must pass the six-step macro-constraint test: lower law, macro map, constraint gate, cost ledger, causal-information witness, and kill condition. | Bridge Laws Between Levels; Paper X; Canonical Claim Matrix CM8h | Structural operationalization of S21; prevents both reductionist erasure and strong-emergence magic |
