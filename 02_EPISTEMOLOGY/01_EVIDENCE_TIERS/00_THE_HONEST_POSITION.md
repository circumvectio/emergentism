...
The bridge currently contains two framework-designed confirmations, one informative negative first run, and several pending tests. The retired survey-study corpus supplies no evidence. See [The Empirical Program Board](../../03_METHODOLOGY/00_EMPIRICAL_PROGRAM_BOARD.md) for the live operating summary.
