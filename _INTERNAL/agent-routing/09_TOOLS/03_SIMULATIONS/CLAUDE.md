...
rosetta:
  ...
  - column: Harness Execution
    level: L4
    role: route runnable simulations, scenario fixtures, and local scripts through
      command receipts
  - column: Claim Boundary
    level: L6
    role: prevent simulation output from becoming doctrine or runtime truth without
      owner-lane promotion
  tier: Executive
  canonical_phrase: "09_TOOLS/03_SIMULATIONS/CLAUDE.md — Agent First-Touch"
---

# 03_SIMULATIONS — Agent First-Touch
