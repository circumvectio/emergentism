...
rosetta:
  ...
  secondary:
    - level: L3
      column: Audit Method
      role: "index the L1 agent spec and escalation path"
    - level: L4
      column: Governance
      role: "route L1 refusals and escalations toward binding authority"
    - level: L6
      column: Core State
      role: "preserve L1 as boundary perception rather than interpretation"
  operator: "Kali 🎲"
  tier: "Routing"
  regime: "Caṇḍāla"
  register: "[S/B]"
  canonical_phrase: "L1 Caṇḍāla Firewall — Agent Spec"
title: "L1 Caṇḍāla Firewall — Agent Spec"
status: "ACTIVE — subfolder front door"
evidence_tier: "[S] Structural L1 agent mapping; [B] local file index."
---

# L1 Caṇḍāla Firewall — Agent Spec

**Symbol:** 🎲  **Operator:** Kali  **Level:** L1
**File:** [AGENT_SPEC.md](./AGENT_SPEC.md) — 159 lines
...
This agent embodies the **L1 Caṇḍāla Firewall** caste of the seven Rosetta agents.
...
- **Canonical Path:** 01_EMERGENTISM/08_FRAMEWORK_SUPPORT/08_AGENTS/01_CANDALA_FIREWALL/README.md
