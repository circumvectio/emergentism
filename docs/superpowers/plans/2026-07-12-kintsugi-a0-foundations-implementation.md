...
- Expected canonical base: `992a8382280d260b2440c140cc28568b468b1678` on `main`.
- [`2026-07-12-kintsugi-a0-concurrency-addendum-992a838.md`](../specs/2026-07-12-kintsugi-a0-concurrency-addendum-992a838.md) records the controlling second inventory and supersedes the earlier execution-base observation.
...
- Preserve the protected public spine file at raw SHA-256 `db794ac3e1d91b9c4d9e92ef121ef016f128a3fb518df86d11b5dc0f5a8eec1c`; it is tracked at the `992a838` base.
...
- [ ] **Step 1: Verify canonical HEAD, branch, A0-path isolation, and protected bytes**

```bash
set -euo pipefail
CANON=/Users/Yves/Documents/01_EMERGENTISM
WT=/Users/Yves/Documents/.codex-worktrees/emergentism-kintsugi-formal-logic
EXPECTED=992a8382280d260b2440c140cc28568b468b1678
...
Expected: exit 0 and no output. Unrelated concurrent dirt may remain in the
canonical checkout; it is preserved and excluded from A0 authority.
...
`sha256:8a6b6209abdaa3f4cf10b1fd50da7a6181fe08bd8f7dbd1fc4726af1448e203b`.
...
{
  "schemaVersion": "1.0.0",
  "baseCommit": "992a8382280d260b2440c140cc28568b468b1678",
...
EXPECTED_CONTRACT_HASH = "sha256:8a6b6209abdaa3f4cf10b1fd50da7a6181fe08bd8f7dbd1fc4726af1448e203b"
...
class ContractTests(unittest.TestCase):
    def test_checked_in_contract_is_exact(self):
        ...
        self.assertEqual(contract["baseCommit"], "992a8382280d260b2440c140cc28568b468b1678")
...
`kintsugi_baseline_failures.json` records 19 baseline node IDs and five exact failure signatures at `main@992a8382280d260b2440c140cc28568b468b1678`. A previously failing node may turn green; a removed node, new failure, exception drift, or signature drift fails. The validator itself introduces no direct writes and disables pytest cache and Python bytecode writes; arbitrary repository test bodies are not sandboxed. The baseline gate has no K2 approval gate.
~~~~
...
test -z "$(git diff --name-only 992a8382280d260b2440c140cc28568b468b1678..HEAD -- "${PROTECTED[@]}")"
...
- [ ] Execution branch descends from exact canonical `main@992a8382280d260b2440c140cc28568b468b1678`.
