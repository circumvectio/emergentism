...
rosetta:
  ...
  regime: "Brāhmaṇa"
  register: "[S]"
  canonical_phrase: "01_EMERGENTISM/09_TOOLS/06_PACKAGES/emergentism-core/src/CLAUDE.md — Agent First-Touch"
---

# src — Agent First-Touch
...
2. [`../../AGENTS.md`](../../AGENTS.md) — packages lane authority

## Scope

- Source code directory for the emergentism-core package.
- Implementation surface; not doctrine or routing authority.
