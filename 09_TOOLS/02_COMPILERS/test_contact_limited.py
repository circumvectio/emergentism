...
class ContactLimitedRatchetTests(unittest.TestCase):
    ...
    def test_live_contract_passes_with_exact_scope(self) -> None:
        ...
        self.assertEqual(
            report["public_lifecycle"]["ignore_counts"],
            {
                ...
                "ignored_html": 209,
                "deployable_html": 210,
                "withheld_artifacts_added_back": 197,
            },
        )
        self.assertEqual(report["public_lifecycle"]["counts"]["total"], 407)
        self.assertEqual(report["public_lifecycle"]["counts"]["current"], 46)
    ...
    def test_sitemap_exactly_matches_indexable_html_classes(self) -> None:
        ...
        self.assertEqual(contract["routes"], 50)
