...
EXTERNAL_SOURCE_CONTRACTS: dict[str, tuple[str, str, str, frozenset[str]]] = {
    "../02_SKYZAI/90_ARCHIVE/2026_09_06_BOOK_SOURCES_HISTORICAL_SOURCE_CUSTODY/ORIGINAL_PATH/03_AIA/EMERGENTISM_AIA/07_DEFINITIVE_ONE_BOOK/00_THE_INFINITE_BOOK_OF_EMERGENCE.md": (
        "081fb55303f07409713c086bbb73bd3d2025eebf14713c54a6629483b91aa3a9",
        "frozen",
        "BK-RECIPROCAL-INFINITE-PLAY",
        frozenset({"book_manifest"}),
    ),
    "../02_SKYZAI/90_ARCHIVE/2026_09_06_BOOK_SOURCES_HISTORICAL_SOURCE_CUSTODY/ORIGINAL_PATH/03_AIA/EMERGENTISM_AIA/08_PRIOR_BOOKS/01_BOOK_I_SARPASYA_VIJAYAM/DISSEMINATION/SARPASYA_VIJAYAM_EDITION_1.md": (
    ...
    "../02_SKYZAI/90_ARCHIVE/2026_08_14_SIX_LENSES_HISTORICAL_SOURCE_CUSTODY/ORIGINAL_PATH/03_AIA/EMERGENTISM_AIA/08_PRIOR_BOOKS/02_BOOK_II_THE_SIX_LENSES/DISSEMINATION/THE_SIX_LENSES_EDITION_1.md": (
        "17ad1a31461f27738b0128a2e53fbed78e5aadeee04ee2de8aadf4cb74fe0ab2",
        "legacy",
        "BK-SIX-LENSES",
        frozenset({"claim_card", "book_manifest"}),
    ),
    "../02_SKYZAI/90_ARCHIVE/2026_09_06_BOOK_SOURCES_HISTORICAL_SOURCE_CUSTODY/ORIGINAL_PATH/03_AIA/EMERGENTISM_AIA/08_PRIOR_BOOKS/03_BOOK_III_THE_SELF_EATING_SERPENT/DISSEMINATION/THE_SELF_EATING_SERPENT_EDITION_1.md": (
        "397ee521026dd999431250bbc55e86181ffc03b6b14a820adf98d70ab81f3ac4",  # pragma: allow-secret -- published source digest
        "legacy",
        "BK-SELF-EATING",
        frozenset({"claim_card", "book_manifest"}),
    ),
    "../02_SKYZAI/01_LEVELS/L5_REFLECTION/03_APU/01_ARCHITECTURE_ENGINE/EMERGENTISM_APU/09_BOOK_PRODUCTION_ARCHIVE/05_SYNTHESIS/07_DEFINITIVE_ONE_BOOK/07_PUBLIC_EDITION/THE_RECIPROCAL_PUBLIC_EDITION_K2_LANG_DECOMM_2026_07_22.md": (
        "86b59d4f3e4ad8ec64e85fb1b075ac986953b3c28339eda1046459789696a1f9",  # pragma: allow-secret -- published source digest
        "frozen",
        "BK-RECIPROCAL-INFINITE-PLAY",
        frozenset({"claim_card", "book_manifest"}),
    ),
    "../02_SKYZAI/90_ARCHIVE/2026_09_05_EVOLUTIONARY_NETWORK_HISTORICAL_SOURCE_CUSTODY/ORIGINAL_PATH/08_EVOLUTIONARY_NETWORK/README.md": (
