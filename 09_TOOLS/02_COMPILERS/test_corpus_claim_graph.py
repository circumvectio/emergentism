...
# Baseline 91 plus OS01-46/47/48 from source commit
# 362180002d22a07b610eed9f1bc9564459ab87c7; not a compiler-derived count.
EXPECTED_REPOSITORY_CARD_COUNT = 94
...
class ClaimGraphContractTests(unittest.TestCase):
    ...
    def test_external_metadata_inventory_is_exactly_six_hash_pins(self) -> None:
        expected = {
            ...
            "../02_SKYZAI/01_LEVELS/L5_REFLECTION/03_AIA/01_ARCHITECTURE_ENGINE/EMERGENTISM_AIA/08_PRIOR_BOOKS/01_BOOK_I_SARPASYA_VIJAYAM/DISSEMINATION/SARPASYA_VIJAYAM_EDITION_1.md": "78595afc40e9535ffd6c197dc047a802486b61315864c0ffa0de0195b97174c2",  # pragma: allow-secret -- reviewed source digest
