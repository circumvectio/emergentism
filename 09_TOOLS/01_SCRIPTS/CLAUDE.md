...
rosetta:
  ...
  - column: Script Audit
    level: L3
    role: require dated receipts for generated output, runtime changes, and deployment
      claims
  - column: Tooling Architecture
    level: L5
    role: route large reusable logic to packages and simulations rather than one-file
      scripts
  - column: Source Boundary
    level: L6
    role: keep script output subordinate to the owning source lane
  tier: God
  canonical_phrase: "09_TOOLS/01_SCRIPTS/CLAUDE.md — Agent First-Touch"
---

# 01_SCRIPTS — Agent First-Touch
