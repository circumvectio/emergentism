...
rosetta:
  ...
  - column: DAC Frame Operations
    level: L4
    role: route executable helpers, validation, and lifecycle scripts through explicit
      commands
  - column: Constitutional Boundary
    level: L6
    role: prevent toolkit support files from silently becoming governing canon
  tier: Executive
  canonical_phrase: "09_TOOLS/09_DAC_FRAME/CLAUDE.md — Agent First-Touch"
---

# 09_DAC_FRAME — Agent First-Touch
