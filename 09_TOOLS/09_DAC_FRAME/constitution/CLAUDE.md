...
rosetta:
  ...
  operator: Viṣṇu ⊙
  primary_column: Constitutional Route Authority
  primary_level: L7
  regime: Ṛṣi
  register: '[I/B]'
  secondary:
  - column: Evidence-Ladder Audit
    level: L3
    role: separate route-card instructions from dated proof artifacts and runtime
      receipts
  ...
  - column: Owner-Lane Boundary
    level: L6
    role: prevent this route card from upgrading nested drafts into public or runtime
      authority
  tier: Executive
  canonical_phrase: "09_TOOLS/09_DAC_FRAME/constitution/CLAUDE.md — Agent First-Touch"
---

# constitution — Agent First-Touch
...
**Lane scope:** Holographic Briefing > Position: 80_DAC_FRAME > 01 CONSTITUTION > Status: Canonical ✅ > Intent: The normative law. What defines Right and Wrong for all agents.
