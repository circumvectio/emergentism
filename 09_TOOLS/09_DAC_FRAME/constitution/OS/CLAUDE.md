...
rosetta:
  ...
  regime: "Brāhmaṇa"
  register: "[S]"
  canonical_phrase: "01_EMERGENTISM/09_TOOLS/09_DAC_FRAME/constitution/OS/CLAUDE.md — Agent First-Touch"
---

# OS — Agent First-Touch
...
2. [`../../AGENTS.md`](../../AGENTS.md) — DAC frame lane authority

## Scope

- Operating-system constitution surface for the DAC frame.
- Implementation configuration; not doctrine authority.
