...
rosetta:
  ...
  - column: Toolchain Architecture
    level: L5
    role: map specialized DAC tools to cartography, validation, court/audit, and monitoring
      helpers
  - column: Executable Boundary
    level: L6
    role: prevent route card from certifying tool safety or runtime behavior
  tier: God
  canonical_phrase: "09_TOOLS/09_DAC_FRAME/tools/CLAUDE.md — Agent First-Touch"
---

# tools — Agent First-Touch
