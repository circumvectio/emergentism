...
rosetta:
  ...
  - column: Audit Execution
    level: L4
    role: route reruns, report generation, and remediation commands through explicit
      receipts
  - column: Dependency-Graph Architecture
    level: L5
    role: preserve link/dependency models without promoting stale outputs to live
      truth
  - column: Artifact Boundary
    level: L6
    role: keep generated audit outputs downstream from source-owner repairs and archive
      policy
  tier: God
  canonical_phrase: "09_TOOLS/08_AUDIT_ARTIFACTS/CLAUDE.md — Agent First-Touch"
---

# 08_AUDIT_ARTIFACTS — Agent First-Touch
