...
rosetta:
  ...
  regime: "Brāhmaṇa"
  register: "[S]"
  canonical_phrase: "01_EMERGENTISM/09_TOOLS/03_SIMULATIONS/00_SCENARIOS/02_withholding/CLAUDE.md — Agent First-Touch"
---

# 02_withholding — Agent First-Touch
...
- Archiver-withhold simulation scenario.
- Assertions, transcript, and YAML configuration for the withholding run.
