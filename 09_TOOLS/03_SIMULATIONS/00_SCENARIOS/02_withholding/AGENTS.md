...
rosetta:
  primary_level: L4
  primary_column: Withholding Scenario Fixture
  secondary:
    - level: L3
      column: Assertion Audit
      role: "bind the archiver-withholding YAML to its transcript and assertion receipt"
    - level: L5
      column: Simulation Architecture
      role: "route withholding assumptions back to the parent harness"
    - level: L6
      column: Fixture Boundary
      role: "prevent one withholding fixture from becoming a full availability proof"
  operator: "Kṛṣṇa ◇"
  tier: "God"
  regime: "Kṣatriya"
  register: "[B/I]"
  canonical_phrase: "02_withholding — Scenario Fixture Routing"
title: "02_withholding — Agent Routing"
status: "ACTIVE — withholding fixture route card"
evidence_tier: "[B] for local YAML/transcript/assertion fixture files; [I] for route-control synthesis."
---

# 02_withholding — Agent Routing

**Lane scope:** 09_TOOLS/03_SIMULATIONS/00_SCENARIOS/02_withholding lane within 01_EMERGENTISM.
