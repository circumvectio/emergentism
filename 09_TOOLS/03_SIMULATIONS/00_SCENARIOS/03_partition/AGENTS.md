...
rosetta:
  primary_level: L4
  primary_column: Partition Scenario Fixture
  secondary:
    - level: L3
      column: Assertion Audit
      role: "bind the network-partition YAML to its transcript and assertion receipt"
    - level: L5
      column: Simulation Architecture
      role: "route partition assumptions back to the parent harness"
    - level: L6
      column: Fixture Boundary
      role: "prevent one partition fixture from becoming a full network-resilience proof"
  operator: "Kṛṣṇa ◇"
  tier: "God"
  regime: "Kṣatriya"
  register: "[B/I]"
  canonical_phrase: "03_partition — Scenario Fixture Routing"
title: "03_partition — Agent Routing"
status: "ACTIVE — partition fixture route card"
evidence_tier: "[B] for local YAML/transcript/assertion fixture files; [I] for route-control synthesis."
---

# 03_partition — Agent Routing

**Lane scope:** 09_TOOLS/03_SIMULATIONS/00_SCENARIOS/03_partition lane within 01_EMERGENTISM.
