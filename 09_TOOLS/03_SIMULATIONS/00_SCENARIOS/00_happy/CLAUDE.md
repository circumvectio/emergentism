...
rosetta:
  ...
  regime: "Brāhmaṇa"
  register: "[S]"
  canonical_phrase: "01_EMERGENTISM/09_TOOLS/03_SIMULATIONS/00_SCENARIOS/00_happy/CLAUDE.md — Agent First-Touch"
---

# 00_happy — Agent First-Touch
...
- Happy-path simulation scenario.
- Assertions, transcript, and YAML configuration for the honest-path run.
