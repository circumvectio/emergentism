...
rosetta:
  ...
  regime: "Brāhmaṇa"
  register: "[S]"
  canonical_phrase: "01_EMERGENTISM/09_TOOLS/03_SIMULATIONS/00_SCENARIOS/01_byzantine/CLAUDE.md — Agent First-Touch"
---

# 01_byzantine — Agent First-Touch
...
1. [`README.md`](README.md) — scenario purpose and assertions
2. [`AGENTS.md`](AGENTS.md) — agent routing, scope boundaries
3. [`../AGENTS.md`](../AGENTS.md) — parent lane authority

## Scope

- Byzantine-fault simulation scenario.
- Assertions, transcript, and YAML configuration for the minority-byzantine run.
