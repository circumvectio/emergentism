...
| Rung | File |
|---|---|
| Front page | `00_THE_SEED.md` — declaration and reading order of the ladder |
| D0 | `D0_THE_FLOOR.md` |
| D1 | `D1_ARITHMETIC.md` |
| D2 | `D2_GEOMETRY.md` |
| D3 | `D3_QUANTUM_STATE.md` (`D3_BODIES.md` retained only as a compatibility tombstone) |
| D4 | `D4_SPACETIME.md` — causal actuality/receipt (legacy filename retained for stable links) |
| D5 | `D5_THE_GAME.md` |
| D6 | `D6_THE_RETURN.md` |
...
Completion-plan tiered-front-door policy (owner directive 2026-07-19 23:20): **SATISFIED
by this file** [S].

## Onward links

- `../../11_UPLINK/50_AUDITS_AND_EXECUTIONS/139_THE_SIGNING_SITTING_SIGNED_2026_07_20.md` — the corrected signing sitting whose box-8 disposition governs this ladder (SIGNED [S]; the 00:01 line, authority record `145_AUTHORITY_FORK_RESOLUTION_2026_07_20.md` under `146_FOUNDER_RULING_EXECUTE_2026_07_20.md`; natural-person signature "I adopt Boxes 1, 2, 4, 5, 7, 8, and 9").
- `../../11_UPLINK/50_AUDITS_AND_EXECUTIONS/139_THE_SIGNING_SITTING_SIGNED_2026_07_19.md` — preserved K3 dissent, **not current authority**. Corrected 2026-07-22: this route card previously named the 07-19 file as the governing box-8 surface, but that record is disputed provenance `[B/D]`, its banner says "AUTHORITY CORRECTION — DO NOT EXECUTE", its box 8 is literally unticked, and its `superseded_by` field names the 07-20 file above. Where the two conflict, the 07-20 file governs.
