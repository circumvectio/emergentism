...
rosetta:
  ...
  register: '[I]'
  tier: Executive
  canonical_phrase: "10_SEED/CLAUDE.md — Agent First-Touch"
---

# 10_SEED — Agent First-Touch
...
- Keep the existing Seed claim `D6 ≡ D0` distinct from the staged Ladder
  relation `D6 ~ D0`; Receipt 139 Box 8 remains unsigned.
