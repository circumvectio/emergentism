...
rosetta:
  primary_level: L2
  primary_column: Ontology — staged contact conjecture
  secondary:
    - level: L3
      column: Audit
...
## 0 · Prior art, first — because most of this wager is already owned
...
## 1 · The owner's statement, and the one retype it needs

Stated 2026-08-22: *forces are in some sense the opposite force to emergence —
gravity at the limit of spacetime consumes all that emerged — every emergent
