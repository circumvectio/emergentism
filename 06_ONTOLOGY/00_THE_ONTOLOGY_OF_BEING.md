...
- **The 7 Generative Actions (L1-L7)** are the complete, exhaustive set of operators by which the whole of Being is navigated. They are the expressions of $P = V \cdot \Phi$: Kali (L1), Kālī (L2), Kṛṣṇa (L3), Arjuna (L4), Brahmā (L5), Śiva (L6), and Viṣṇu (L7).
